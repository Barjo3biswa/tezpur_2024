...
<body>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-md-4 col-xl-4">
						<div id="logo">
							<a href="{{url("/")}}"><img src="{{asset("website/img/logo.jpg")}}" alt="" title="logo" /></a>
						</div>
					</div>
	...
	<script src="{{asset("website/js/popper.min.js")}}" type="text/javascript"></script>
	<script src="{{asset("website/js/bootstrap.min.js")}}" type="text/javascript"></script>
	<script src="{{asset("website/js/custom.js")}}" type="dc1d43e4638e00e8b931e7d2-text/javascript"></script>
	@yield("js")
</body>
</html>