                                ...
                                @for($i=0; $i<=1; $i++)
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="padding-xs" style="text-align: center;" colspan="4">
                                                    ...
                                                    <p class="mb-4 bold tezu--heading-print-para">B.Tech Admission Record Form<br/>@if ($i == 0)
                                                        Student Copy
                                                    @else
                                                        Academic Copy
                                                    @endif</p>
                                            ...
                                            <tr>
                                                <th>Name of the candidate in capital letters :</th>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="4">Relevant documemts of the above candidate selected for admission into B.Tech programme in the <b>{{ $merit_list->course->name }}</b> discipline under the <b>@if ($merit_list->admissionReceipt->admission_category->id == 1)
                                                Unreserved
                                                @else
                                                ...
                                                @if ($merit_list->is_pwd == 1)
                                                (PWD)
                                                @endif </b> category against NE / JoSSA / CSAB / NEUT / DASA / JnK seats have been verified as per the checklist . He / she is recommended for / admission /
                                            ...
                                            <tr>
                                                ...
                                                <th>Previous Counselling</th>
                                                <td>
                                                    @if($merit_list->btechPrevious)
                                                        @if($merit_list->btechPrevious->status==3)
                                                            {{ $merit_list->btechPrevious->course->name }} 
                                                            ({{$merit_list->btechPrevious->admissionReceipt->roll_number}}) 
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            @php
                                                $test_this = $merit_list->btechPrevious->status??0;
                                            @endphp
                                            @if($test_this!=3)
                                                <tr>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>  
                                            ...
                                            <tr>
                                                <th colspan="2">Signature of the warden  </th>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="4">Admission fees Rs…………………paid by cash / vide draft no……………dated…………….</td>
                                            </tr>
                                            <tr>                                            
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th colspan="4" style="float: right;">Signature of officer-in-charge</th>
                                            </tr>
                                            <tr>
