            ...
            <div class="panel panel-default">
                                    ...
                                    <tr>
                                        <td class="padding-xs" style="text-align: center;" colspan="4">
                                            ...
                                            NAPAAM, TEZPUR - 784028, ASSAM<br> 
                                                    <br /><span class="text-danger">Seat Declined by {{$merit_list->seat_declined_by}}</span>
                                            </strong><br>
                                            </p>
                                        </td>
                                    </tr>
                ...
                <div class="row">
                    <div class="col-md-12" style="float:left;margin-left:20px">
                        <span><u>Seat Decline Reason:</u>&nbsp; {{$merit_list->declined_text}}</span>
                    </div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-md-12" style="float:left;margin-left:20px">
                        <span><u>Seat Decline Coment:</u>&nbsp; {{$merit_list->declined_remark}}</span>
                    </div>
                </div>
                <br/>
                <div class="row">
