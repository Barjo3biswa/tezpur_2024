                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="" method="get">
                            @include('department-user.withdrawal-request.filter')
                        </form>
                    </div>
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="...">
                                                    @if($w_request->status == "request_sent")
                                                        @include('department-user.withdrawal-request.approve-modal', ["request" => $w_request])
                                                        @include('department-user.withdrawal-request.reject-modal', ["request" => $w_request])
                                                    @else
