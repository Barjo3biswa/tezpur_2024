									...
									<tbody>
										<tr>
											<td class="padding-xs" style="text-align: center;" colspan="4">
												...
												NAPAAM, TEZPUR - 784028, ASSAM<br> <strong> Provisional Receipt for Hostel Fee (Student / Academic)
										...
										<tr>
											...
											<td>
												{{-- {{$merit_list->hostelReceipt->admission_category->id}} --}}
												@if($merit_list->hostelReceipt->admission_category->id==1)
													Unreserved
												@else
													{{$merit_list->hostelReceipt->admission_category->name ?? "NA"}}
												@endif
