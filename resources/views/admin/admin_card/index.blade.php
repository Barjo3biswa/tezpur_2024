                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                ...
                                <tr id="row_{{$admit_card->id}}" data-center-id="{{Crypt::encrypt($admit_card->id)}}"
                                    ...
                                    <td class="center_code">
                                        {{ $admit_card->active_application->application_no ?? "----" }}
                                    </td>
                                    <td class="center_name">{{$admit_card->active_application->student_id}}</td>
                                    <td class="address">{{$admit_card->active_application->fullname}}</td>
