                                    ...
                                    @foreach ($courses as $key=>$course)
                                        ...
                                        <tr>
                                            ...
                                            @foreach($course->courseSeats as $key=>$courseSeat) 
                                                ...
                                                <th>
                                                    <span class="badge" style="background:#000;font-size:16px">{{$courseSeat->total_seats}}</span>
                                                    <span class="badge tezu-admission-{{$courseSeat->id}}" style="background:#ff0000;font-size:16px">{{$courseSeat->total_seats_applied}}</span>
                                                    <span class="badge" id="tezu-admission-{{$courseSeat->id}}" style="background:#00a65a;font-size:16px">{{intval($courseSeat->total_seats)-intval($courseSeat->total_seats_applied)}}</span> 
                                                </th>            
                                                @endif
                                            @endforeach     
                                        </tr>
