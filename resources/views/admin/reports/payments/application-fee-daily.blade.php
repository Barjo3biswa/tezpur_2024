        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route("admin.reports.application-payments") }}" method="GET">
                        @include ("admin.reports.payments.filter")
                    </form>
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading"><strong>Application fee collections:</strong>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        @include ("admin.reports.payments.application-fee-daily-table", ["payments" => $payments])
                    </div>
                </div>
            </div>
        </div>
