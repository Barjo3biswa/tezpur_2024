                            ...
                            <tbody>
                                @forelse ($merit_lists as $key=>$list)
                                    <tr>
                                        ...
                                        <td>
                                            @if($list->may_slide==1 && $list->status==2)
                                               <a href="{{ route(get_route_guard() . '.merit.slide-admission-cat', Crypt::encrypt($list->id)) }}" class="btn btn-primary btn-sm">Slide Admission Category</a>
                                            @endif
                                        </td>
                                    </tr> 
                                @empty
