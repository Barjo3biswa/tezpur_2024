...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-heading">Add Department User <span class="pull-right"><a href="{{route("admin.department-users.index")}}"><button class="btn btn-sm btn-primary"><i class="fa fa-list"></i> All Department users</button></a></span></div>
                <div class="panel-body">
                   @include("admin.department_user.form")
                </div>
            </div>
        </div>
    </div>
