        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form name="merit" id="merit" action="{{ route('admin.merit.admission_category_update') }}"
                        method="POST">
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @if ($merit_lists->count())
                                    <div class="text-right">
                                        <button type="button" class="btn btn-primary" id="approve" >Update Admission Category</button>
                                            ...
                                            <div class="modal-body">
                                                <div class="container-fluid">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label class="date_time"> Select Category</label>
                                                            </div>
                                                           
                                                            <div class="col-md-6">
                                                            <select name="category_update_id" required id="category_update_id" class="js-example-basic-single" style="width:100% !important"  autocomplete="off">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-2 col-md-offset-3">
                                                               <input type="radio" name="merit" value="1" required>  Merit
                                                            </div>
                                                            <div class="col-md-3">
                                                               <input type="radio" name="merit" value="0" required>  Waiting
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        {{ $merit_lists->appends(request()->all())->links() }}
