<a class="btn btn-danger btn-xs" data-toggle="modal" href='#rejectModal{{$request->id}}'>Reject</a>
<div class="modal fade" id="rejectModal{{$request->id}}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route("admin.merit.withdrawal-request.reject", $request->id)}}" method="POST">
                {{ csrf_field() }}
