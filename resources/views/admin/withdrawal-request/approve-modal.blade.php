<a class="btn btn-success btn-xs" data-toggle="modal" href='#approveModal{{$request->id}}'>Approve</a>
<div class="modal fade" id="approveModal{{$request->id}}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{route("admin.merit.withdrawal-request.approve", $request)}}">
