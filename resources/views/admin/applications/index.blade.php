        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{route("admin.application.index", request()->all())}}" method="get" >
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Applications 
                    ...
                    <span class="pull-right" style="margin-left: 15px"><a href="{{request()->fullUrlWithQuery(['export-data' => 1])}}"><button class="btn btn-sm btn-primary"><i class="fa fa-file-excel-o"></i> Export to Excel</button></a></span>
                    <span class="pull-right"><a href="{{request()->fullUrlWithQuery(['export' => "zip"])}}"  onClick="return checkProgramSelection(this, event)"><button class="btn btn-sm btn-info"><i class="fa fa-file-archive-o"></i>  Export to Zip</button></a></span>
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{route("admin.application.sms.send")}}" onsubmit="return applicationSelected(this)">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="defaultCheck1" name="send_email">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <th>Allow Resubmit Document?</th>
                                    <th id="">
                                        <div class="checkbox">
                                            <label for="resubmit_allow">
                                                <input type="checkbox" id="resubmit_allow" name="resubmit_allow" value="1" class="form-control">
                                            </label>
                                          </div>
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <th id="">
                                        <div class="checkbox">
                                            <label for="allow_to_edit">
                                                <input type="checkbox" id="allow_to_edit" name="allow_to_edit" value="yes" class="form-control">
                                            </label>
                                          </div>
                                    </th>
                                </tr>
                                <tr>
                                    <th>Allow to upload compulsory document again?</th>
                                    <th id="">
                                        <div class="checkbox">
                                            <label for="allow_to_doc_upload">
                                                <input type="checkbox" id="allow_to_doc_upload" name="allow_to_doc_upload" value="yes" class="form-control">
                                            </label>
                                          </div>
                                    </th>
                                </tr>
                                <tr>
                                    <th>Allow to check eligibility again?</th>
                                    <th id="">
                                        <div class="checkbox">
                                            <label for="allow_to_eligibility_check">
                                                <input type="checkbox" id="allow_to_eligibility_check" name="allow_to_eligibility_check" value="yes" class="form-control">
                                            </label>
                                          </div>
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <th id="">
                                        <div class="checkbox">
                                            <label for="re_payment">
                                                <input type="checkbox" name="re_payment" id="re_payment" value="1" class="form-control">
                                            </label>
                                          </div>
                                    </th>
                                </tr>
...
<script>
    ...
    checkProgramSelection = function(obj, event){
        $this = $(obj);
        var program = $("#program").val();
        if(program && program !== ""){
            return true;
        }else{
            alert("Please select a program to export as zip.");
            event.preventDefault();
            return false;
        }
    }
