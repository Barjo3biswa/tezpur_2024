    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            ...
            <select name="EXAM_THROUGH" id="EXAM_THROUGH" class="form-control input-sm select2">
                ...
                <option value="ECE" {{request()->get("EXAM_THROUGH") == "ECE" ? "selected" : ""}}>ECE</option>
                <option value="JEE" {{request()->get("EXAM_THROUGH") == "JEE" ? "selected" : ""}}>JEE-NE</option>
                <option value="JOSSA" {{request()->get("EXAM_THROUGH") == "JOSSA" ? "selected" : ""}}>JOSSA</option>
            </select>
        </div>
