...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="state" class="form-control" placeholder="State" @isset($exam_center)
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="number" size="6" minlength="4" maxlength="6" name="pin" min="0" class="form-control"
                    required placeholder="Pin/Zip" @isset($exam_center) value="{{old("pin",$exam_center->pin)}}" @else
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label for="country_id" class="col-md-3 control-label text-right margin-label">
                Country: <span class="text-danger">*</span></label>
            <div class="col-md-8">
                <select name="country_id" id="country" class="form-control">
                    @foreach (countries_array() as $id => $name)
                        <option value="{{$id}}" {{old("country_id", $exam_center->country_id ?? null) == $id ? "selected" : ""}}>{{$name}}</option>
                    @endforeach
                </select>
            </div>
        </div>
