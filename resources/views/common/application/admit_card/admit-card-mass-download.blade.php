    ...
    <table width="100%" class="table-2">
        <tr>
            <td width=20% rowspan="6" style="text-align: center;" >
                <img style="width: 121px; height:180px;"
            ...
            <td width=15%><strong>Exam Date/Time</strong></td>
            <td width=25%> <strong>{{ $admit_card->course->ExamGroup->exam_date }} &nbsp; {{ $admit_card->course->ExamGroup->exam_time }}</strong></td>
        </tr>
        <tr>
