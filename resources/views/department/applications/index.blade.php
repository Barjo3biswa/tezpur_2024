    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{route(get_route_guard().".application.sms.send")}}" onsubmit="return applicationSelected(this)">
                        {{ csrf_field() }}
                            ...
                            <tbody>
                                    ...
                                    <th id="">
                                        <div class="checkbox">
                                            <label for="resubmit_allow">
                                                <input type="checkbox" name="resubmit_allow" value="1" class="">
                                            </label>
                                          </div>
                                    </th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <th id="">
                                        <div class="checkbox">
                                            <label for="resubmit_allow">
                                                <input type="date" name="resubmit_date" class="form-control">
                                            </label>
                                          </div>
                                    </th>
                                </tr>
...
<script>
    var verification_url = '{{url(get_route_guard()."/application/accept/")}}';
    var reject_url = '{{url(get_route_guard()."/application/reject/")}}';
    var hold_url = '{{url(get_route_guard()."/application/hold/")}}';
