          ...
          <div class="panel-body">
                  ...
                  ">
                    <div class="col-md-4">
                      <div class="row2">
                        ...
                        <div class="col-course-name text-primaey text-bold" style="margin-top:10px;">
                          {{ course.name }}
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="row2">
                        ...
                        <div class="col-course-name text-info text-bold" style="margin-top:10px;" v-html="course.eligibility"></div>
                      </div>
                    </div>
                    <!-- Ends -->
            ...
            "> 
              ...
              <div class="col-md-12" style="padding-top:18px;">
                <div class="panel panel-info">
                  ...
                  <!--<div class="panel-body text-info text-bold"> I have read through the prospectus throughly <a href="this.base_url+notifications/2022/Prospectus_2022.pdf">Click Here</a>  </div>-->
                  ...
                  <div class="row" v-if="is_60 == true">
                    <div class="col-md-12">
                      <div class="checkbox" style="padding-left:12px;">
                        <label>
                          <input type="checkbox" v-model="initial_step.is_qualify" />I have read through the prospectus throughly
                        </label>
            ...
            <div v-if="this.initial_step.program_selection_step == false">
              <div class="alert alert-danger">
                <strong>Error!! Unable to continue :: </strong> Either same preference is given for multiple courses or Preference selection is not in sequence .
              </div>                
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <form-input :label="'1. (a) First Name'" :input_data="step_one_form.first_name"
                    :errors="step_one_form.errors" :error_attr="'first_name'" :placeholder="'First Name'"
                    :required="true" :disabled="applications_count == '0' ? false : true"
                  ...
                  <form-input :label="'(c) Last Name'" :input_data="step_one_form.last_name"
                    :errors="step_one_form.errors" :error_attr="'last_name'" :placeholder="'Last Name'"
                    :required="false" :disabled="applications_count == '0' ? false : true"
                    :label_style="'margin-left:12px;'" @inputDataChanged="step_one_form.last_name = $event">
                  </form-input>
                  ...
                  <date-picker :label="'5. Date of birth ( as per matriculation certificate)'" :input_data="step_one_form.dob" :errors="step_one_form.errors"
                    :error_attr="'dob'" :required="true" @dateChanged="step_one_form.dob = $event"
                  ...
                  <form-select :label="'6. (a) Category'" :options="castes" :errors="step_one_form.errors"
                    ...
                    :old_value="step_one_form.caste" :old_value_attr="'id'"
                    @changedSelect="step_one_form.caste = $event" v-if="is_foreign == false"></form-select>

                  <form-input :label="'(b) Caste'" :input_data="step_one_form.sub_caste" :errors="step_one_form.errors"
                    :error_attr="'sub_caste'" :placeholder="'Caste'" :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.sub_caste = $event" v-if="is_foreign == false"></form-input>
                  <form-input :label="
                    is_foreign == true ? '6. PAN NO' : '7. PAN NO'
                  " :input_data="step_one_form.pan_no" :errors="step_one_form.errors" :error_attr="'pan_no'"
                    :placeholder="'PAN No'" @inputDataChanged="step_one_form.pan_no = $event" :required="false">
                  </form-input>
                  <form-input :label="
                    is_foreign == true ? '6. Aadhaar No' : '7. Aadhaar No'
                  " :input_data="step_one_form.adhaar" :errors="step_one_form.errors" :error_attr="'adhaar'"
                    :placeholder="'Aadhaar No'" @inputDataChanged="step_one_form.adhaar = $event"></form-input>

                  <form-input :label="is_foreign == true ? '7. DigiLocker ID' : '8. DigiLocker ID'"
                    :input_data="step_one_form.nad_id" :errors="step_one_form.errors" :error_attr="'nad_id'"
                    :placeholder="'DigiLocker ID'" @inputDataChanged="step_one_form.nad_id = $event"></form-input>

                  <form-input :label="
                    is_foreign == true
                      ? '8. Passport Number'
                      : '9. Passport Number'
                  " :input_data="step_one_form.passport_number" :errors="step_one_form.errors"
                  ...
                  " :input_data="step_one_form.driving_license_equivalnet_no" :errors="step_one_form.errors"
...
"></form-input>
                  ...
                  <div class="form-group" v-if="is_mba == false">
                    <label class="col-md-7">
                      <span v-if="is_foreign == true">10</span><span v-else>9</span> . Are you employed? :
                      <span class="text-danger">*</span> <br />
                      <small class="text-primary" v-if="step_one_form.is_employed"><i class="fa fa-info-circle"></i> NOC
                        must be produced
                        if selected.</small>
                    </label>
                    <div class="col-md-5">
                  ...
                  <div class="form-group">
                    <label class="col-md-7">
                      <span v-if="is_foreign == true">11</span><span v-else>10</span>. Are you a person with disability
                      (PWD)? :
                    </label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                  ...
                  <form-input :label="'Please specify'" :input_data="step_one_form.pwd_exp"
                    :errors="step_one_form.errors" :error_attr="'pwd_explain'" :placeholder="'Please specify'"
                    :required="false" :label_style="'margin-left:12px;'" :show_text_limit="true"
                    @inputDataChanged="step_one_form.pwd_exp = $event" v-if="step_one_form.is_pwd"></form-input>

                  <div class="form-group">
                    <label class="col-md-7">
                      <span v-if="is_foreign == true">12</span><span v-else>11</span>. Are you ex-Servicemen or
                  ...
                  <div class="form-group" v-if="step_one_form.is_ex_serviceman == true">
                    <label class="col-md-7">
                      <span style="margin-left:14px;">Do you want to apply in defence quota ? :</span>
                      <span class="text-danger">*</span>
                    </label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                  ...
                  <div class="form-group" v-if="is_foreign == false">
                    <label class="col-md-7"><span v-if="is_foreign == true">13</span><span>12</span> Are you a Kashmiri
                      Migrant (KM) ?
                      :</label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                  ...
                  <div class="form-group" v-if="is_foreign == false">
                    <label class="col-md-7">15. Do you belong to minority community ? :</label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                  ...
                  <div class="form-group" v-if="is_phd">
                    <label class="col-md-7">16. Whether passed/appeared the qualification exam?:</label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                      ...
                      <label class="radio-inline">
                        <input type="radio" :value="'appeared'"
                  ...
                  <div class="form-group" v-if="is_phd">
                    <label class="col-md-7">17. Whether applying for full time/part time?:</label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                  ...
                  <div class="form-group" v-if="is_phd">
                    <label class="col-md-7">18. Experience related to:</label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                ...
                <div class="col-md-6">
                  <form-input :label="
                    is_foreign == true
                      ? '13 (a) Father\'s Name'
                      : '16 (a) Father\'s Name'
                  " :input_data="step_one_form.father_name" :errors="step_one_form.errors"
                    :error_attr="'father_name'" :placeholder="'Father Name'" :required="false"
                  ...
                  <form-input :label="'Occupation'" :input_data="step_one_form.father_occupation"
                    ...
                    :required="false" :label_style="'margin-left:12px;'"
                  ...
                  <form-input :label="'Mobile No'" :input_data="step_one_form.father_mobile"
                    :errors="step_one_form.errors" :error_attr="'father_mobile'" :placeholder="'Mobile'"
                    :required="false" :label_style="'margin-left:12px;'"
                  ...
                  <form-input :label="'Email'" :input_data="step_one_form.father_email" :errors="step_one_form.errors"
                    :error_attr="'father_email'" :placeholder="'Email'" :required="false"
                  ...
                  <form-input :label="'(b) Mother\'s Name'" :input_data="step_one_form.mother_name"
                    ...
                    :required="false" @inputDataChanged="step_one_form.mother_name = $event"></form-input>
                  ...
                  <form-input :label="'Mobile No'" :input_data="step_one_form.mother_mobile"
                    :errors="step_one_form.errors" :error_attr="'mother_mobile'" :placeholder="'Mobile'"
                    :required="false" :label_style="'margin-left:12px;'"
                  ...
                  <form-input :label="'Email'" :input_data="step_one_form.mother_email" :errors="step_one_form.errors"
                    :error_attr="'mother_email'" :placeholder="'Email'" :required="false"
                  ...
                  <form-input :label="'Mobile No'" :input_data="step_one_form.guardian_mobile"
                  ...
                  <!--<label class="col-md-12">
                    (b) Applicant Bank information <span style="font-size:14px;color:#D10000;">(For 1st Semester Fee Refund Purpose)</span>
                  </label>
                  <form-input :label="'A/C Holder Name'" :input_data="step_one_form.account_holder_name"
                    ...
                    :required="true" :label_style="'margin-left:35px;'"
                    @inputDataChanged="step_one_form.account_holder_name = $event"></form-input>
                  <form-input :label="'Bank A/C No'" :input_data="step_one_form.bank_ac_no"
                    :errors="step_one_form.errors" :error_attr="'bank_ac_no'" :placeholder="'Bank ac no'"
                    :required="true" :label_style="'margin-left:35px;'"
                    @inputDataChanged="step_one_form.bank_ac_no = $event"></form-input>

                  <form-input :label="'Bank Name'" :input_data="step_one_form.bank_name" :errors="step_one_form.errors"
                    :error_attr="'bank_name'" :placeholder="'Bank name'" :required="true"
                  ...
                  <form-input :label="'IFSC code'" :input_data="step_one_form.ifsc_code" :errors="step_one_form.errors"
                    :error_attr="'ifsc_code'" :placeholder="'IFSC Code'" :required="true"
                  ...
                  <form-input :label="'Mobile No'" :input_data="step_one_form.bank_reg_mobile_no"
                    ...
                    :placeholder="'Bank Registered Mobile No'" :required="true" :label_style="'margin-left:35px;'"
            ...
            <fieldset id="personal_information">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <form-input :label="'(g) District'" :input_data="step_two_form.correspondence.district"
                    ...
                    "></form-input>
                  <form-select :label="'(h) State'" :options="states" :errors="step_two_form.errors"
                    :error_attr="'correspondence_state'" :value_attr="'name'" :name_attr="'name'" :required="true"
                    :old_value="step_two_form.correspondence.state" :old_value_attr="'name'"
                    @changedSelect="step_two_form.correspondence.state = $event" v-if="!is_foreign"></form-select>
                  <form-input :label="'(h) State / UT'" :input_data="step_two_form.correspondence.state"
                    :errors="step_two_form.errors" :error_attr="'correspondence_state'" :placeholder="'State'"
                    @inputDataChanged="
                      step_two_form.correspondence.state = $event
                    " v-if="is_foreign"></form-input>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <section>
                    <form-input :label="'(a) C/O'" :input_data="step_two_form.permanent.co"
                      :errors="step_two_form.errors" :error_attr="'permanent_co'" :placeholder="'C/O'"
                  ...
                  <section>
                    ...
                    <form-input :label="'(f) P.O'" :input_data="step_two_form.permanent.po"
                      :errors="step_two_form.errors" :error_attr="'permanent_po'" :placeholder="'P.O'"
                      @inputDataChanged="step_two_form.permanent.po = $event"></form-input>

                    <form-input :label="'(g) District'" :input_data="step_two_form.permanent.district"
                      :errors="step_two_form.errors" :error_attr="'permanent_district'" :placeholder="'District'"
                      @inputDataChanged="
                        step_two_form.permanent.district = $event
                      "></form-input>
                    <form-select :label="'(h) State'" :options="states" :errors="step_two_form.errors"
                      :error_attr="'permanent_state'" :value_attr="'name'" :name_attr="'name'" :required="true"
                      :old_value="step_two_form.permanent.state" :old_value_attr="'name'"
                      @changedSelect="step_two_form.permanent.state = $event" v-if="!is_foreign"></form-select>
                    <form-input :label="'(h) State / UT'" :input_data="step_two_form.permanent.state"
                ...
                <div class="col-md-6">
                  <form-input :label="'3. Contact No'" :input_data="step_two_form.contact_no"
                    :errors="step_two_form.errors" :error_attr="'contact_no'" :placeholder="'Contact No'"
                    :disabled="true" @inputDataChanged="step_two_form.contact_no = $event"></form-input>
                    ...
                    <tr>
                      ...
                      <td>
                        <!-- <input
                          ...
                          min="0"
                        /> -->
                        <select v-model="step_three_form.academic10.passing_year" class="form-control input-sm"
                          required>
                          <option value selected disabled>--SELECT--</option>
                    ...
                    <tr>
                      <th>
                        ...
                        <form-select :label="'Stream'" :options="streams" :errors="step_three_form.errors"
                          style="margin-top:12px;" :value_attr="'name'" :name_attr="'name'" :required="false" :is_break_label="true"
                          :old_value="step_three_form.academic12.stream" :old_value_attr="'name'" @changedSelect="
                      ...
                      <td>
                        <!-- <input
                          ...
                          min="0"
                        /> -->
                        <select v-model="step_three_form.academic12.passing_year" class="form-control input-sm"
                          required>
                          <option value selected disabled>--SELECT--</option>
    ...
    step_three_form.errors.academic12_marks_percentage
                    ...
                    <tr v-if="initial_step.is_cuet_pg == true">
                      <th>
                    ...
                    <tr v-if="initial_step.is_cuet_pg == true">
                      <th>
                        ...
                        " :options="post_degrees" :errors="step_three_form.errors" :error_attr="'master_degree'"
                          :value_attr="'name'" :name_attr="'name'" :required="is_mtech ? false : true"
                          :is_break_label="true" :old_value="
...
"></form-select>
      ...
      .academic_diploma_marks_percentage
              ...
              <label>
                <span class="text-info">Pre-Qualifying/ Semester wise/ Year wise/ Any Other Qualification Marks of
                  Qualifying Exam (Please enter information here by clicking Add New button)</span>
              </label>
    ...
    step_three_form.other_qualifications.errors.remarks
              ...
              <div class="row jee" v-if="initial_step.is_cuet_ug == true || initial_step.is_cuet_pg == true">
                <div class="col-md-12">
                  <label>
                    <span class="text-info" > 2. CUET Details</span><span class="text-danger">*</span> 
                  ...
                  <div class="panel panel-default">
                    <div class="panel-body">
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-md-7">
                              <input type="text" v-model="step_three_form.cuet.cuet_roll_no"   @change="addNewCuetDtls"
                                class="form-control input-sm input-sm" />
                     ...
                     <!--<div class="row">
                      ...
                      <div v-for="(cuet, index) in step_three_form 
                           .cuet.subject_wise_dtl" :key="index"> 
                        <div class="row">
                          <div class="form-group">
                          
                              <div class="col-md-1"></div>
                               <label class="col-md-1" v-if="initial_step.is_cuet_ug == true && index==0">Language Subjects</label>
                               <label class="col-md-1" v-if="initial_step.is_cuet_pg == true ">Test Code</label>
                               <label class="col-md-1" v-if="initial_step.is_cuet_ug == true && index!=0"> Domain Subjects</label>
                              <div class="col-md-2" v-if="index==0">
                                <select v-model="cuet.subjects" class="form-control input-sm" v-if="initial_step.is_cuet_ug == true" required>
                                  <option value selected disabled>--SELECT--</option>
                                  <option value="English">English</option>
                                </select>

                                <select v-model="cuet.subjects" class="form-control input-sm" v-if="initial_step.is_cuet_pg == true" @change="subjectChanged(cuet.subjects,index)" required>
                                  <option value selected disabled>--SELECT--</option>
                                  <option :value="val.subject_name" v-for="val in cuet_subject">{{ val.subject_name }}</option>
                                </select>

                              </div>
                              <div class="col-md-2" v-if="index!=0">
                                <select v-model="cuet.subjects" class="form-control input-sm" @change="subjectChanged(cuet.subjects,index)" required>
                                  <option value selected disabled>--SELECT--</option>
                                  <option :value="val.subject_name" v-for="val in cuet_subject">{{ val.subject_name }}</option>
                                </select>
                              </div>
                              <label class="col-md-1">CUET Score</label>
                              <div class="col-md-2">
                                <input required type="text" v-model="cuet.marks" class="form-control input-sm input-sm" />
                              </div> 
                              <label class="col-md-1">CUET Percentile(*00 if not applicable)</label>
                              <div class="col-md-2">
                                <input required type="text" v-model="cuet.percentile" class="form-control input-sm input-sm" />
                              </div> 
                             
                              <div class="col-md-1">
                                <button type="button" class="btn btn-xs btn-warning" @click="removeCuetDtl(cuet,index)" v-if="index!=0">
                                  Remove
                                </button>
              ...
              <div class="row jee" v-if="isThisCourseApplied('MTECH(removed)')==true">
                <div class="col-md-12">
                  <label>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <form-input :label="'CUET score'" :input_data="step_three_form.gate.gate_score"
                              ...
                              :show_text_limit="false" v-if="step_three_form.is_gate_qualified == true"
                              @inputDataChanged="
                          ...
                          <div class="col-md-4">
                            <form-input :label="'CUET Rank'" :input_data="step_three_form.gate.gate_rank"
                              :errors="step_three_form.errors" :error_attr="'gate_rank'"
                              :placeholder="'Enter CUET Rank'" :required="false" :label_style="'margin-left:12px;'"
                              :show_text_limit="false" v-if="step_three_form.is_gate_qualified == true"
                              @inputDataChanged="
              ...
              <div class="row mba" v-if="isThisCourseApplied('MBA') == true">
                <div class="col-md-12">
                  <label>
                    *. CAT/MAT/ATMA/XAT Details (only for MBA student) (if not enter <span class="text-info">NA,
                      Zero</span>)
                  </label>
                  <div class="panel panel-default">
                    <div class="panel-body">
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              <tr v-for="(data, index) in step_three_form.mba_exam_data.details" :key="index">
                                ...
                                <td>
                                  <input type="text" v-model="data.registration_no" class="form-control input-sm"
                                    value="" required />
                                ...
                                <td>
                                  <input type="date" class="form-control input-sm" v-model="data.date_of_exam"
                                    required />
                                  <small class="text-danger"
              ...
              <div class="row" v-if="isThisCourseApplied('MBA') == true">
                <div class="col-sm-12">
                  <div class="table-responsive">
                    <h3>Work Experience(For MBA Students)</h3>
                    <table class="table table-bordered">
                      <thead>
                        <th>Organization</th>
                        <th>Designation</th>
                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group" v-if="is_phd">
                        <label for="proposed_area_of_research" class="col-md-7">
                          <span v-if="is_phd == true"></span>
                          <span v-else></span> . Proposed area of research ?
                          <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-5">
                          <table>
                      ...
                      <div class="form-group" v-if="is_phd">
                        <label for="proposed_area_of_research" class="col-md-7">
                          <span v-if="is_phd == true"></span>
                          <span v-else></span> . Qualified National level test?
                        </label>
                        <div class="col-md-5">
                          ...
                          <div class="input-group">
                            ...
                            <div class="input-group-btn" v-if="isThisUploaded('passport_photo')==true">
                              <button type="button" class="btn btn-success btn-sm"
                                :disabled="singleFileUploadingProgress"
    ...
    step_four_form.errors2.document_passport_photo
                  ...
                  <section v-if="this.step_one_form.caste != '1'">
                    <div class="form-group">
                      <label for="document_undertaking" class="col-md-4 margin-label">
                        Undertaking for Category Certificate <strong class="text-danger">*</strong><small
                          class="text-muted">(for all programmes)</small>
                        :
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="undertaking" class="form-control input-sm input-sm"
                            @change="undertakingFileChanged" accept=".jpg,.jpeg,.png" />
                        ...
                        <small class="text-info"><strong>Max-size: 1MB , File type: JPEG,JPG, PNG</strong>
                        </small>
              ...
              <section v-if="!is_foreign">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_prc" class="form-control input-sm input-sm"
                            @change="prcFileChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn" v-if="isThisUploaded('prc')==true">
                            <button type="button" class="btn btn-success btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('document_prc', 'prc')">
                              <i class="fa fa-upload"></i> Uploaded
                            </button>
                          </div>
                          <div class="input-group-btn" v-if="isThisUploaded('prc')==false">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('document_prc', 'prc')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                    ...
                    <div class="row" v-if="step_four_form.prc_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.prc_url)"><img :src="step_four_form.prc_url" alt="undertaking" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="isThisCourseApplied('MTECH(removed)')==true">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_gate_card" class="form-control input-sm input-sm"
                            @change="gateCardFileChanged" accept=".jpg,.jpeg,.png" />
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors.gate_score_card">{{ step_four_form.errors.gate_score_card
                          }}</strong>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" v-if="step_four_form.gate_score_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.gate_score_card_url)"><img :src="step_four_form.gate_score_card_url" alt="undertaking" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="caste_certificate" class="form-control input-sm input-sm"
                            @change="casteCertificateChanged" accept=".jpg,.jpeg,.png" />
                    ...
                    <div class="row" v-if="step_four_form.caste_certificate_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.caste_certificate_url)"><img :src="step_four_form.caste_certificate_url" alt="undertaking" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="gate_b_score_card" class="form-control input-sm input-sm"
                            @change="gateBScoreCardChange" accept=".jpg,.jpeg,.png" />
                        ...
                        <small class="text-info"><strong>Max-size: 5MB , File type: JPEG,JPG, PNG</strong>
                        </small>
                        <strong class="text-danger" style="display:block"
                    ...
                    <div class="row" v-if="step_four_form.gate_b_score_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.gate_b_score_card_url)"><img :src="step_four_form.gate_b_score_card_url" alt="undertaking" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="is_master_in_design">
                      <label for="ceed_score_card" class="col-md-4 margin-label">CEED score card (only for master of
                        Design) <strong class="text-danger">*</strong>:</label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="ceed_score_card" class="form-control input-sm input-sm"
                            @change="CeedScoreCardChange" accept=".jpg,.jpeg,.png" />
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors.ceed_score_card">{{ step_four_form.errors.ceed_score_card
                          }}</strong>
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.ceed_score_card">{{ step_four_form.errors2.ceed_score_card
                          }}</strong>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" v-if="step_four_form.ceed_score_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.ceed_score_card_url)"><img :src="step_four_form.ceed_score_card_url" alt="undertaking" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="isThisSubCourseApplied(84)">
                      <label for="portfolio" class="col-md-4 margin-label">Portfolio (only for master of Design) <strong
                          class="text-danger">* (Only PDF Allowed)</strong>:</label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="portfolio_file" class="form-control input-sm input-sm"
                            @change="portfolioChange" accept=".pdf" />
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.portfolio_file">{{ step_four_form.errors2.portfolio_file
                          }}</strong>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_bpl" class="form-control input-sm input-sm"
                            @change="bplFileChanged" accept=".jpg,.jpeg,.png" />
                    ...
                    <div class="row" v-if="step_four_form.bpl_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.bpl_card_url)"><img :src="step_four_form.bpl_card_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="is_ncl == true">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="obc_ncl" class="form-control input-sm input-sm"
                            @change="obcFileChanged" accept=".jpg,.jpeg,.png" />
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.obc_ncl">{{ step_four_form.errors2.obc_ncl
                          }}</strong>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" v-if="step_four_form.obc_ncl_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.obc_ncl_url)"><img :src="step_four_form.obc_ncl_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-md-6">
                  <section v-if="is_foreign">
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="passport" class="form-control input-sm input-sm"
                            @change="passportFileChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn" v-if="isThisUploaded('passport')==true">
                            <button type="button" class="btn btn-success btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('passport', 'passport')">
                              <i class="fa fa-upload"></i> Uploaded
                            </button>
                          </div>
                          <div class="input-group-btn" v-if="isThisUploaded('passport')==false">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('passport', 'passport')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                  ...
                  <div class="row" v-if="step_four_form.document_passport_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <a @click="openImageInNewWindow(step_four_form.document_passport_url)"><img :src="step_four_form.document_passport_url" alt="bpl" width="100px" /></a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group" v-if="step_three_form.is_sport_represented == true">
                    <label for="document_sport_representation" class="col-md-4 margin-label">Certificate of winning Medals in any National and International Sports events :
                    </label>
                    <div class="col-md-7">
                      <div class="input-group">
                        <input type="file" ref="document_sport_representation" class="form-control input-sm input-sm"
                          @change="sportCertificateChanged" accept=".jpg,.jpeg,.png" />
                      ...
                      <strong class="text-danger" style="display:block"
                        v-if="step_four_form.errors.sport_certificate">{{ step_four_form.errors.sport_certificate
                        }}</strong>
                      <strong class="text-danger" style="display:block" v-if="
                  ...
                  <div class="row" v-if="this.step_four_form.sport_certificate_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <a @click="openImageInNewWindow(step_four_form.sport_certificate_url)"><img :src="step_four_form.sport_certificate_url" alt="Passport Photo" width="100px" /></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-7">
                      <div class="input-group">
                        <input type="file" ref="document_pwd" class="form-control input-sm input-sm"
                          @change="pwdCertificateChanged" accept=".jpg,.jpeg,.png" />
                  ...
                  <div class="row" v-if="step_four_form.document_pwd_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <a @click="openImageInNewWindow(step_four_form.document_pwd_url)"><img :src="step_four_form.document_pwd_url" alt="bpl" width="100px" /></a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group" v-if="step_one_form.is_employed == true && isThisCourseApplied('MBA') == false">
                    ...
                    <div class="col-md-7">
                      <div class="input-group">
                        <input type="file" ref="document_noc" class="form-control input-sm input-sm"
                          @change="nocFileChanged" accept=".jpg,.jpeg,.png" />
                  ...
                  <div class="row" v-if="step_four_form.document_noc_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <a @click="openImageInNewWindow(step_four_form.document_noc_url)"><img :src="step_four_form.document_noc_url" alt="bpl" width="100px" /></a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <section>
                    <div class="form-group">
                      <label for="document_undertaking" class="col-md-4 margin-label">
                        Undertaking for (Passed/Appeared) <strong class="text-danger">*</strong><small
                          class="text-muted">(for all programmes)</small>
                        :
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="undertaking_pass_appear" class="form-control input-sm input-sm"
                            @change="undertakingPassAppearFileChanged" accept=".jpg,.jpeg,.png" />
                  ...
                  <div class="row" v-if="step_four_form.undertaking_pass_appear_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <a @click="openImageInNewWindow(step_four_form.undertaking_pass_appear_url)"><img :src="step_four_form.undertaking_pass_appear_url" alt="bpl" width="100px" /></a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <section v-if="!is_foreign">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="initial_step.is_btech == true">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_admit_jee" class="form-control input-sm input-sm"
                            @change="admiCardChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn" v-if="isThisUploaded('jee_admit')==true">
                            <button type="button" class="btn btn-success btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('document_admit_jee', 'jee_admit')">
                              <i class="fa fa-upload"></i> Uploaded
                            </button>
                          </div>
                          <div class="input-group-btn" v-if="isThisUploaded('jee_admit')==false">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('document_admit_jee', 'jee_admit')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                    ...
                    <div class="row" v-if="step_four_form.document_admit_jee_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.document_admit_jee_url)"><img :src="step_four_form.document_admit_jee_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="initial_step.is_cuet_ug == true || initial_step.is_cuet_pg == true">
                      <label for="cuet_admit_card" class="col-md-4 margin-label">
                        Admit Card of CUET(anyone) (for UG / PG Programme) :
                        <span class="text-danger">*</span>
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="cuet_admit_card" class="form-control input-sm input-sm"
                            @change="cuetAdmitCardChanged" accept=".jpg,.jpeg,.png" />
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.cuet_admit_card">{{ step_four_form.errors2.cuet_admit_card
                          }}</strong>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" v-if="step_four_form.cuet_admit_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.cuet_admit_card_url)"><img :src="step_four_form.cuet_admit_card_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group" v-if="initial_step.is_cuet_ug == true || initial_step.is_cuet_pg == true">
                      <label for="cuet_score_card" class="col-md-4 margin-label">
                        Score Card of CUET (for UG / PG Programme) :
                        <span class="text-danger">*</span>
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="cuet_score_card" class="form-control input-sm input-sm"
                            @change="cuetScoreCardChanged" accept=".jpg,.jpeg,.png" />
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.cuet_score_card">{{ step_four_form.errors2.cuet_score_card
                          }}</strong>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" v-if="step_four_form.cuet_score_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.cuet_score_card_url)"><img :src="step_four_form.cuet_score_card_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="bank_passbook" class="form-control input-sm input-sm"
                            @change="bankPassbookChanged" accept=".jpg,.jpeg,.png" />
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_net_slet" class="form-control input-sm input-sm"
                            @change="netSletFileChanged" accept=".jpg,.jpeg,.png" />
                    ...
                    <div class="row" v-if="step_four_form.document_net_slet_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.document_net_slet_url)"><img :src="step_four_form.document_net_slet_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_ex_servicement" class="form-control input-sm input-sm"
                            @change="exservicemanFileChanged" accept=".jpg,.jpeg,.png" />
              ...
              <section v-if="is_foreign">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="driving_license" class="form-control input-sm input-sm"
                            @change="drivingLicenseFileChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn" v-if="isThisUploaded('driving_license')==true">
                            <button type="button" class="btn btn-success btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('driving_license', 'driving_license')">
                              <i class="fa fa-upload"></i> Uploaded
                            </button>
                          </div>
                          <div class="input-group-btn" v-if="isThisUploaded('driving_license')==false">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('driving_license', 'driving_license')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors.driving_license">{{ step_four_form.errors.driving_license
                          }}</strong>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" v-if="step_four_form.document_driving_license_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.document_driving_license_url)"><img :src="step_four_form.document_driving_license_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="ssn_equivalent" class="form-control input-sm input-sm"
                            @change="ssnFileChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn" v-if="isThisUploaded('ssn_certificate')==true">
                            <button type="button" class="btn btn-success btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('ssn_equivalent', 'ssn_certificate')">
                              <i class="fa fa-upload"></i> Uploaded
                            </button>
                          </div>
                          <div class="input-group-btn" v-if="isThisUploaded('ssn_certificate')==false">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('ssn_equivalent', 'ssn_certificate')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors.ssn_certificate">{{ step_four_form.errors.ssn_certificate
                          }}</strong>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" v-if="step_four_form.document_ssn_equivalent_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.document_ssn_equivalent_url)"><img :src="step_four_form.document_ssn_equivalent_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="passing_certificate" class="col-md-4 margin-label">
                        Passing Certificate of qualifying exam:
                        <span class="text-danger">*</span>
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="passing_certificate" class="form-control input-sm input-sm"
                            @change="passingCertificateFileChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn" v-if="isThisUploaded('passing_certificate')==true">
                            <button type="button" class="btn btn-success btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('passing_certificate', 'passing_certificate')">
                              <i class="fa fa-upload"></i> Uploaded
                            </button>
                          </div>
                          <div class="input-group-btn" v-if="isThisUploaded('passing_certificate')==false">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('passing_certificate', 'passing_certificate')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                    ...
                    <div class="row" v-if="step_four_form.document_passing_certificate_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.document_passing_certificate_url)"><img :src="step_four_form.document_passing_certificate_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="marksheet" class="form-control input-sm input-sm"
                            @change="markSheetFileChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn" v-if="isThisUploaded('qualifying_marksheet')==true">
                            <button type="button" class="btn btn-success btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('marksheet', 'qualifying_marksheet')">
                              <i class="fa fa-upload"></i> Uploaded
                            </button>
                          </div>
                          <div class="input-group-btn" v-if="isThisUploaded('qualifying_marksheet')==false">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('marksheet', 'qualifying_marksheet')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                    ...
                    <div class="row" v-if="step_four_form.document_marksheet_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <a @click="openImageInNewWindow(step_four_form.document_marksheet_url)"><img :src="step_four_form.document_marksheet_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="english_proficiency_certificate"
                            class="form-control input-sm inpu0t-sm" @change="proficiencyFileChanged"
                            accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn" v-if="isThisUploaded('english_proficiency_certificate')==true">
                            <button type="button" class="btn btn-success btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('english_proficiency_certificate', 'english_proficiency_certificate')">
                              <i class="fa fa-upload"></i> Uploaded
                            </button>
                          </div>
                          <div class="input-group-btn" v-if="isThisUploaded('english_proficiency_certificate')==false">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('english_proficiency_certificate', 'english_proficiency_certificate')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                    ...
                    <div class="row" v-if="step_four_form.document_english_proficiency_certificate_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                               <a @click="openImageInNewWindow(step_four_form.document_english_proficiency_certificate_url)"><img :src="step_four_form.document_english_proficiency_certificate_url" alt="bpl" width="100px" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-7">
                      <div class="input-group">
                        <input type="file" ref="additional_document" class="form-control input-sm input-sm"
                          @change="additionalFileChanged" accept=".jpg,.jpeg,.png" />
                        ...
                        <div class="col-md-7">
                          <div class="input-group">
                            <input type="file" class="form-control input-sm input-sm"
                              @change="anyDcoumentsChange($event, mba_exam)" accept=".jpg,.jpeg,.png" />
              ...
              <li><strong></strong>Upload Marksheet, Certificate with conversion formula issued by your University/ Board/ Council.</strong></li>
              ...
              <li><strong></strong>Upload This Three Document In One PDF File. </strong></li>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.class_x_documents">{{ step_four_form.errors2.class_x_documents
                          }}</strong>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        ...
                        <strong class="text-danger" style="display:block" v-if="step_four_form.errors.class_XII_documents">{{
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        ...
                        <strong class="text-danger" style="display:block" v-if="step_four_form.errors.class_x_grade_conversion">{{
                            step_four_form.errors.class_x_grade_conversion
                        }}</strong>
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.class_x_grade_conversion">{{ step_four_form.errors2.class_x_grade_conversion
                          }}</strong>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="class_XII_grade_conversion" class="col-md-4 margin-label">
                        Class XII Grade Conversion Formula :
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                        ...
                        <strong class="text-danger" style="display:block" v-if="step_four_form.errors.class_XII_grade_conversion">{{
                            step_four_form.errors.class_XII_grade_conversion
                        }}</strong>
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.class_XII_grade_conversion">{{ step_four_form.errors2.class_XII_grade_conversion
                          }}</strong>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="initial_step.is_cuet_pg == true">
                      ...
                      <div class="col-md-7">
                        ...
                        <strong class="text-danger" style="display:block" v-if="step_four_form.errors.graduation_documents">{{
                  ...
                  <div class="col-md-6">
                    <div class="form-group" v-if="initial_step.is_cuet_pg == true">
                      ...
                      <div class="col-md-7">
                        ...
                        <strong class="text-danger" style="display:block" v-if="step_four_form.errors.post_graduation_documents">{{
                            step_four_form.errors.post_graduation_documents
                        }}</strong>
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.post_graduation_documents">{{ step_four_form.errors2.post_graduation_documents
                          }}</strong>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group" v-if="initial_step.is_cuet_pg == true">
                      ...
                      <div class="col-md-7">
                        ...
                        <strong class="text-danger" style="display:block" v-if="step_four_form.errors.graduation_grade_conversion">{{
                            step_four_form.errors.graduation_grade_conversion
                        }}</strong>
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.graduation_grade_conversion">{{ step_four_form.errors2.graduation_grade_conversion
                          }}</strong>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group" v-if="initial_step.is_cuet_pg == true">
                      ...
                      <div class="col-md-7">
                        ...
                        <strong class="text-danger" style="display:block" v-if="step_four_form.errors.post_graduation_grade_conversion">{{
                            step_four_form.errors.post_graduation_grade_conversion
                        }}</strong>
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.post_graduation_grade_conversion">{{ step_four_form.errors2.post_graduation_grade_conversion
                          }}</strong>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  data() {
    return {
      ...
      // base_url: "http://139.59.46.246/tezu-demo/public/",
  ...
  methods: {
    ...
    loadOldApplication(id) {
      axios({
        ...
        // console.log(response.application_old.first_name);
    ...
    proficiencyFileChanged() {
      ...
      this.step_four_form.document_english_proficiency_certificate_url = URL.createObjectURL(
        this.step_four_form.document_document_english_proficiency_certificate
      );
    },
    ...
    openProspectusInNewWindow() {
      // alert("okk");
      window.open(
        this.base_url + '/notifications/2022/Prospectus_2022.pdf', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');
    },
