              ...
              <div class="col-md-12" style="padding-top:18px;">
                <div class="panel panel-info">
                  <h5 class="text-center" style="font-size:14px;font-weight:550;">
                    ...
                    <span v-else>Declaration II {{this.step}}</span>
                  </h5>
                  <!--<div class="panel-body text-info text-bold"> I have read through the prospectus throughly <a href="this.base_url+notifications/2022/Prospectus_2023(mba).pdf">Click Here</a>  </div>-->
...
"></form-input>
                  ...
                  <div class="form-group" v-if="isThisCourseApplied('MBA') == true">
    ...
    step_three_form.errors.academic12_marks_percentage
                    ...
                    <tr v-if="initial_step.is_cuet_pg == true || initial_step.is_phd == true || initial_step.is_mba == true">
                      <th>
...
"></form-select>
    ...
    step_three_form.errors
      .academic_diploma_marks_percentage
              ...
              <label>
                ...
                <span class="text-danger">For PHD students (Please enter NET/GATE examination details using ADD NEW button)</span>
              </label>
    ...
    step_three_form.other_qualifications.errors.remarks
              ...
              <div class="row" v-if="isThisCourseApplied('MBA') == true">
                <div class="col-sm-12">
                  <div class="table-responsive">
                    <h3>Work Experience(For MBA Students)(If Any)</h3>
                    <table class="table table-bordered">
                      <thead>
                        <th>Organization</th>
                        <th>Designation</th>
                  ...
                  <section v-if="this.step_one_form.caste != '1'">
                    <div class="form-group">
                      <label for="document_undertaking" class="col-md-4 margin-label">
                        Undertaking for Category Certificate <strong class="text-danger" v-if="initial_step.is_mba=false">*</strong><small
                          class="text-muted" v-if="initial_step.is_mba=false">(for all programmes)</small>
                        :
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
              ...
              <div class="row" v-if="initial_step.is_mba_edit==false">
                <div class="col-md-6">
                  <section>
                    <div class="form-group">
                      <label for="document_undertaking" class="col-md-4 margin-label">
                        Undertaking for (Passed/Appeared) <strong class="text-danger" v-if="initial_step.is_mba == false">*</strong><small
                          class="text-muted" v-if="initial_step.is_mba == false">(for all programmes)</small>
                        :
                      </label>
                      <div class="col-md-7">
...
export default {
  ...
  methods: {
    ...
    openProspectusInNewWindow() {
      // alert("okk");
      window.open(
        this.base_url + '/notifications/2022/Prospectus_2023(mba).pdf', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');
    },
