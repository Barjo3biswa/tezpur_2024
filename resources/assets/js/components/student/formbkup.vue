        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <select
                  v-model="initial_step.course_type"
                ...
                >
                  ...
                  <option
                    :value="type"
                    :key="type.id"
                    v-for="type in initial_step.course_types"
                    >{{ type.name }}</option
                  >
                </select>
              </div>
            ...
            >
              ...
              <div
                class="row"
                v-if="initial_step.is_pref_limit_exceeded == true"
              >
                <div class="col-md-12" style="padding:14px;">
                  <div class="alert-blue">
                    <i class="fa fa-info text-white"></i> You can select upto
                    seven programs only (for B.Tech)
                  </div>
                </div>
              </div>
              <small
                class="text-danger text-center"
                v-if="initial_step.preference_error"
                style="margin:12px 12px;"
                >{{ initial_step.preference_error }}</small
              >
              <section
                v-for="course in initial_step.combined_courses"
                :key="course.id"
              >
                <section v-if="course.id != initial_step.course.id">
                  ...
                  >
                      ...
                      <div class="row2">
                        <div class="col-checkbox">
                          <div class="checkbox" style="padding-left:14px;">
                            <input
                              type="checkbox"
                              :checked="course.is_checked == true"
                              :disabled="
                    ...
                    <div class="col-md-5" style="padding-bottom:12px;">
                      <section v-if="course.is_checked == true">
                        <select
                          class="form-control input-sm input-sm"
                          @change="preferenceChanged($event, course.id)"
                          :disabled="
                            initial_step.is_pref_limit_exceeded == true &&
                            course.is_checked == false
                              ? true
                        ...
                        >
                          <option value selected disabled>--SELECT--</option>
                          <option
                            v-for="(n, index) in initial_step.combined_courses
                              .length - 1"
                            :key="index"
                            :value="n + 1"
                            >{{ n + 1 }}</option
                        ...
                        <small
                          ><strong class="text-info"
                            >Preference : {{ course.preference }}</strong
                          ></small
                        >
                      </section>
                    </div>
            ...
            <div
              class="row"
              v-if="is_sub_preference == true && initial_step.course"
            >
              <h5 class="text-center" style="font-size:14px;font-weight:550;">
              ...
              <ul class="text-notice">
                ...
                <li v-if="is_integrated"><small>If you select both the programs then specify your preferences accordingly.</small></li>
              ...
              <div class="col-md-12" style="padding-top:18px;">
                <div class="panel panel-info">
                  ...
                  >
                    ...
                    <span v-else>Eligibility Criteria</span>
                  </h5>
                  <div
                    class="panel-body text-info text-bold"
                    v-html="initial_step.course.eligibility"
                  ></div>
                  ...
                  <section v-if="is_lateral == true">
                    <div class="row">
                      <div class="col-md-12">
                        <h5 class="text-center" style="font-weight:600;">
                          <strong
                            >Do you possess 60% marks in Mathematics?</strong
                          >
                        </h5>
                      </div>
                    </div>
                    ...
                    <div class="row" v-if="is_60 == false">
                      <div class="col-md-12">
                        ...
                        >
                          <strong
                            >Sorry, you don't qualify for this course</strong
                          >
                        </h5>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="checkbox" style="padding-left:12px;">
                        <label>
                          <input
                            type="checkbox"
                            v-model="initial_step.is_qualify"
                          />I qualify
                        </label>
                      </div>
                      <div
    ...
    <div class="row" v-if="step == 1">
      <div class="col-md-12">
        <form
          ...
          autocomplete="off"
          class="form-horizontal application-form"
        >
          <br />
          <div class="step personal_information">
            <fieldset id="personal_information">
              ...
              <div class="row">
                <div class="col-md-6">
                  <form-input
                    :label="'1. (a) First Name'"
                    :input_data="step_one_form.first_name"
                    :errors="step_one_form.errors"
                    :error_attr="'first_name'"
                    :placeholder="'First Name'"
                    :required="true"
                    :disabled="applications_count == '0' ? false : true"
                    @inputDataChanged="step_one_form.first_name = $event"
                  ></form-input>
                  <form-input
                    :label="'(b) Middle Name'"
                    :input_data="step_one_form.middle_name"
                    :errors="step_one_form.errors"
                    :error_attr="'middle_name'"
                    :placeholder="'Middle Name'"
                    :required="false"
                    :disabled="applications_count == '0' ? false : true"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.middle_name = $event"
                  ></form-input>
                  <form-input
                    :label="'(c) Last Name'"
                    :input_data="step_one_form.last_name"
                    :errors="step_one_form.errors"
                    :error_attr="'last_name'"
                  ...
                  <form-select
                    ...
                    :name_attr="'name'"
                    :required="true"
                    :old_value="step_one_form.religion"
                    :old_value_attr="'name'"
                    @changedSelect="step_one_form.religion = $event"
                  ></form-select>
                  <form-input
                    :label="'Please Specify'"
                    :input_data="step_one_form.religion"
                    :errors="step_one_form.errors"
                    :error_attr="'religion'"
                    :placeholder="'Please specify'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    :show_text_limit="true"
                    @inputDataChanged="step_one_form.other = $event"
                    v-if="showOtherInput == true"
                  ></form-input>
                  ...
                  <form-select
                    ...
                    :name_attr="'name'"
                    :required="true"
                    :old_value="step_one_form.gender"
                    :old_value_attr="'name'"
                    @changedSelect="step_one_form.gender = $event"
                  ></form-select>

                  <form-select
                    :label="'4. Marital Status'"
                    :options="martital_options"
                    :errors="step_one_form.errors"
                    :error_attr="'marital_status'"
                    :value_attr="'value'"
                    :name_attr="'name'"
                    :required="true"
                    :old_value="step_one_form.marital_status"
                    :old_value_attr="'name'"
                    @changedSelect="step_one_form.marital_status = $event"
                  ></form-select>

                  <date-picker
                    :label="'5. DOB'"
                    :input_data="step_one_form.dob"
                    :errors="step_one_form.errors"
                    :error_attr="'dob'"
                    :required="true"
                    @dateChanged="step_one_form.dob = $event"
                    :not_after="disabledAfter">
                  ></date-picker>
                  ...
                  <form-select
                    ...
                    :name_attr="'name'"
                    :required="true"
                    :old_value="step_one_form.caste"
                    :old_value_attr="'id'"
                    @changedSelect="step_one_form.caste = $event"
                    v-if="is_foreign == false"
                  ></form-select>

                  <form-input
                    :label="'(b) Caste'"
                    :input_data="step_one_form.sub_caste"
                    :errors="step_one_form.errors"
                    :error_attr="'sub_caste'"
                    :placeholder="'Caste'"
                    :required="true"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.sub_caste = $event"
                    v-if="is_foreign == false"
                  ></form-input>
                  <form-input
                    :label="
                    ...
                    "
                    :input_data="step_one_form.pan_no"
                    :errors="step_one_form.errors"
                    :error_attr="'pan_no'"
                    :placeholder="'PAN No'"
                    @inputDataChanged="step_one_form.pan_no = $event"
                    :required="false"
                  ></form-input>
                  <form-input
                    :label="
                    ...
                    "
                    :input_data="step_one_form.adhaar"
                    :errors="step_one_form.errors"
                    :error_attr="'adhaar'"
                    :placeholder="'Aadhaar No'"
                    @inputDataChanged="step_one_form.adhaar = $event"
                  ></form-input>

                  <form-input
                    :label="is_foreign == true ? '7. DigiLocker ID' : '8. DigiLocker ID'"
                    :input_data="step_one_form.nad_id"
                    :errors="step_one_form.errors"
                    :error_attr="'nad_id'"
                    :placeholder="'DigiLocker ID'"
                    @inputDataChanged="step_one_form.nad_id = $event"
                  ></form-input>
                  ...
                  <form-input
                    :label="
                      is_foreign == true
                        ...
                        : '9. Passport Number'
                    "
                    :input_data="step_one_form.passport_number"
                    :errors="step_one_form.errors"
                    :error_attr="'passport_number'"
                    :placeholder="'Passport No'"
                    v-if="is_foreign == true"
                    @inputDataChanged="step_one_form.passport_number = $event"
                  ></form-input>
                  <form-input
                    :label="
                      is_foreign == true
                        ? '9. Driving License Social security number or equivalent'
                        : '10. Driving License Social security number or equivalent'
                    "
                    :input_data="step_one_form.driving_license_equivalnet_no"
                    :errors="step_one_form.errors"
                    :error_attr="'driving_license_equivalnet_no'"
                    :placeholder="
                  ...
                  <div class="form-group"  v-if="is_mba == false">
                    <label class="col-md-7">
                      <span v-if="is_foreign == true">10</span
                      ><span v-else>9</span> . Are you employed? :
                      <span class="text-danger">*</span> <br />
                      <small
                        class="text-primary"
                        v-if="step_one_form.is_employed"
                        ><i class="fa fa-info-circle"></i> NOC must be produced
                        if selected.</small
                      >
                    </label>
                    <div class="col-md-5">
                        ...
                        <div class="col-md-12">
                          <label class="radio-inline">
                            <input
                              type="radio"
                              :value="true"
                              v-model="step_one_form.is_employed"
                              id="is_employed"
                            />
                            <span class="text-warning">Yes</span>
                          </label>
                      ...
                      <div class="row" v-if="step_one_form.is_employed == true">
                        <div class="col-md-10">
                          <select
                            class="form-control input-sm"
                            v-model="step_one_form.employment_details"
                          >
                          ...
                          <small
                            class="text-danger"
                            v-if="step_one_form.errors.employment_details"
                            >{{
                  ...
                  <div class="form-group">
                    <label class="col-md-7">
                      <span v-if="is_foreign == true">11</span
                      ><span v-else>10</span>. Are you a person with disability
                      (PWD)? :
                    </label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                  ...
                  <form-input
                    :label="'Please specify'"
                    :input_data="step_one_form.pwd_exp"
                    :errors="step_one_form.errors"
                    :error_attr="'pwd_explain'"
                    :placeholder="'Please specify'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    :show_text_limit="true"
                    @inputDataChanged="step_one_form.pwd_exp = $event"
                    v-if="step_one_form.is_pwd"
                  ></form-input>

                  <div class="form-group">
                    <label class="col-md-7">
                      <span v-if="is_foreign == true">12</span
                      ><span v-else>11</span>. Are you ex-Servicemen or
                      widow/ward of ex-Serviceman? :
                    ...
                    <div class="col-md-5">
                      <label class="radio-inline">
                        <input
                          type="radio"
                          :value="true"
                          v-model="step_one_form.is_ex_serviceman"
                          id="is_ex_serviceman"
                        />
                        <span class="text-warning">Yes</span>
                      </label>
                  ...
                  <div
                    class="form-group"
                    v-if="step_one_form.is_ex_serviceman == true"
                  >
                    <label class="col-md-7">
                    ...
                    <div class="col-md-5">
                      <label class="radio-inline">
                        <input
                          type="radio"
                          :value="true"
                          v-model="step_one_form.is_aplly_defense_quota"
                          id="is_ex_serviceman"
                        />
                        <span class="text-warning">Yes</span>
                      </label>
                  ...
                  <form-select
                    ...
                    :options="step_one_form.priorities"
                    :errors="step_one_form.errors"
                    :error_attr="'priority'"
                    :value_attr="'id'"
                    :name_attr="'name'"
                    :required="true"
                    :label_style="'margin-left:12px;'"
                    :old_value="step_one_form.priority"
                    :old_value_attr="'id'"
                    @changedSelect="step_one_form.priority = $event"
                    v-if="
                  ...
                  <div class="form-group" v-if="is_foreign == false">
                    <label class="col-md-7"
                      ><span v-if="is_foreign == true">13</span
                      ><span>12</span> Are you a Kashmiri Migrant (KM) ?
                      :</label
                    >
                    <div class="col-md-5">
                      <label class="radio-inline">
                  ...
                  <form-input
                    :label="'Please specify'"
                    :input_data="step_one_form.km_details"
                    :errors="step_one_form.errors"
                    :error_attr="'km_details'"
                    :placeholder="'Please specify'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    :show_text_limit="true"
                    @inputDataChanged="step_one_form.km_details = $event"
                    v-if="step_one_form.is_km"
                  ></form-input>
                  <div class="form-group" v-if="is_foreign == false">
                    <label class="col-md-7"
                      >13. Are you a student from Jammu & Kashmir?:</label
                    >
                    <div class="col-md-5">
                      <label class="radio-inline">
                        <input
                          type="radio"
                          :value="true"
                          v-model="step_one_form.is_jk_student"
                          id="is_jk_student"
                        />
                        <span class="text-warning">Yes</span>
                      </label>
                  ...
                  <div class="form-group" v-if="is_foreign == false">
                    <label class="col-md-7">
                      14 . Do you belong to BPL/AAY?:
                      <br />
                      <small
                        class="text-primary"
                        v-if="step_one_form.is_bpl == true"
                        ><i class="fa fa-info-circle"></i> BPL/AAY certificate
                  ...
                  <div class="form-group" v-if="is_foreign == false">
                    <label class="col-md-7"
                      >15. Do you belong to minority community ? :</label
                    >
                    <div class="col-md-5">
                      <label class="radio-inline">
                        <input
                          type="radio"
                          :value="true"
                          v-model="step_one_form.is_minority"
                          id="is_minority"
                        />
                        <span class="text-warning">Yes</span>
                      </label>
                  ...
                  <form-input
                    :label="'Please specify'"
                    :input_data="step_one_form.minority_details"
                    :errors="step_one_form.errors"
                    :error_attr="'minority_details'"
                    :placeholder="'Please specify'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    :show_text_limit="true"
                    @inputDataChanged="step_one_form.minority_details = $event"
                    v-if="step_one_form.is_minority"
                  ></form-input>
                  <div class="form-group" v-if="is_phd">
                    <label class="col-md-7"
                      >16. Whether passed/appeared the qualification exam?:</label
                    >
                    <div class="col-md-5">
                      <label class="radio-inline">
                        <input
                          type="radio"
                          :value="'passed'"
                          v-model="step_one_form.passed_or_appeared_qualified_exam"
                   ...
                   <div class="form-group" v-if="is_phd">
                    <label class="col-md-7"
                      >17. Whether applying for full time/part time?:</label
                    >
                    <div class="col-md-5">
                      <label class="radio-inline">
                        <input
                          type="radio"
                          :value="true"
                          v-model="step_one_form.is_full_time"
                          id="is_full_time"
                        />
                  ...
                  <form-input
                  v-if="!step_one_form.is_full_time && is_phd"
                    :label="'Furnish Designation with office address of the College/Office wherein he/she is working?'"
                    :input_data="step_one_form.part_time_details"
                    :errors="step_one_form.errors"
                    :error_attr="'part_time_details'"
                    :placeholder="'Please specify'"
                    :required="false"
                    :show_text_limit="true"
                    @inputDataChanged="step_one_form.part_time_details = $event"
                  ></form-input>
                   <div class="form-group" v-if="is_phd">
                    <label class="col-md-7"
                      >18. Experience related to:</label
                    >
                    <div class="col-md-5">
                      <label class="radio-inline">
                        <input
                          ...
                          v-model="step_one_form.academic_experience"
                      ...
                      <div class="form-group" v-if="is_phd">
                        <label for="proposed_area_of_research" class="col-md-7">
                          <span >19</span>. Publication Details  (if any)
                          <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-5">
                          <textarea
                            ...
                            rows="2"
                            required
                            v-model="step_one_form.publication_details"
                            class="form-control input-sm"
                          ...
                          <small
                            class="text-danger"
                            v-if="step_one_form.errors.publication_details"
                            >{{
                      ...
                      <div class="form-group" v-if="is_phd">
                        <label for="proposed_area_of_research" class="col-md-7">
                          <span>20</span> .Statement of Purpose (SOP) of research (maximum 250-300 words)
                          <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-5">
                          <textarea
                            ...
                            rows="2"
                            required
                            v-model="step_one_form.statement_of_purpose"
                            class="form-control input-sm"
                          ...
                          <small
                            class="text-danger"
                            v-if="step_one_form.errors.statement_of_purpose"
                            >{{
                ...
                <div class="col-md-6">
                  <form-input
                    :label="
                      is_foreign == true
                        ...
                        : '16 (a) Father\'s Name'
                    "
                    :input_data="step_one_form.father_name"
                    :errors="step_one_form.errors"
                    :error_attr="'father_name'"
                    :placeholder="'Father Name'"
                    :required="false"
                    @inputDataChanged="step_one_form.father_name = $event"
                  ></form-input>

                  <form-input
                    :label="'Occupation'"
                    :input_data="step_one_form.father_occupation"
                    :errors="step_one_form.errors"
                    :error_attr="'father_occupation'"
                    :placeholder="'Occupation'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.father_occupation = $event"
                  ></form-input>
                  
                  <form-input
                    :label="'Mobile No'"
                    :input_data="step_one_form.father_mobile"
                    :errors="step_one_form.errors"
                    :error_attr="'father_mobile'"
                    :placeholder="'Mobile'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.father_mobile = $event"
                  ></form-input>

                  <form-input
                    :label="'Email'"
                    :input_data="step_one_form.father_email"
                    :errors="step_one_form.errors"
                    :error_attr="'father_email'"
                    :placeholder="'Email'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.father_email = $event"
                  ></form-input>
                  <form-input
                    :label="'(b) Mother\'s Name'"
                    :input_data="step_one_form.mother_name"
                    :errors="step_one_form.errors"
                    :error_attr="'mother_name'"
                    :placeholder="'Mother Name'"
                    :required="true"
                    @inputDataChanged="step_one_form.mother_name = $event"
                  ></form-input>

                  <form-input
                    :label="'Occupation'"
                    :input_data="step_one_form.mother_occupation"
                    :errors="step_one_form.errors"
                    :error_attr="'mother_occupation'"
                    :placeholder="'Occupation'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.mother_occupation = $event"
                  ></form-input>
                  
                  <form-input
                    :label="'Mobile No'"
                    :input_data="step_one_form.mother_mobile"
                    :errors="step_one_form.errors"
                    :error_attr="'mother_mobile'"
                    :placeholder="'Mobile'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.mother_mobile = $event"
                  ></form-input>

                  <form-input
                    :label="'Email'"
                    :input_data="step_one_form.mother_email"
                    :errors="step_one_form.errors"
                    :error_attr="'mother_email'"
                    :placeholder="'Email'"
                    :required="false"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.mother_email = $event"
                  ></form-input>

                  <form-input
                    :label="'(c) Guardian\'s Name'"
                    :input_data="step_one_form.guardian_name"
                    :errors="step_one_form.errors"
                    :error_attr="'guardian_name'"
                    :placeholder="'Guardian Name'"
                    :required="true"
                    @inputDataChanged="step_one_form.guardian_name = $event"
                  ></form-input>

                  <form-input
                    :label="'Occupation'"
                    :input_data="step_one_form.guardian_occupation"
                    :errors="step_one_form.errors"
                    :error_attr="'guardian_occupation'"
                    :placeholder="'Occupation'"
                    :required="true"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="
                  ...
                  <form-input
                    :label="'Mobile No'"
                    :input_data="step_one_form.guardian_mobile"
                    :errors="step_one_form.errors"
                    :error_attr="'guardian_mobile'"
                    :placeholder="'Mobile'"
                    :required="true"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.guardian_mobile = $event"
                  ></form-input>

                  <form-input
                    :label="'Email'"
                    :input_data="step_one_form.guardian_email"
                    :errors="step_one_form.errors"
                    :error_attr="'guardian_email'"
                    :placeholder="'Email'"
                    :required="true"
                    :label_style="'margin-left:12px;'"
                    @inputDataChanged="step_one_form.guardian_email = $event"
                  ></form-input>
                  <form-select
                    :label="'(d) Family Income'"
                    :options="income_ranges"
                    :errors="step_one_form.errors"
                    :error_attr="'family_income'"
                    :value_attr="'id'"
                    :name_attr="'min'"
                    :name_attr2="'max'"
                    :required="true"
                    :old_value="step_one_form.family_income"
                    :old_value_attr="'id'"
                    :label_style="'margin-left:12px;'"
                    @changedSelect="step_one_form.family_income = $event"
                  ></form-select>
                  <div class="form-group">
                    <label class="col-md-7">
                      ...
                      <small
                        class="text-primary"
                        v-if="step_one_form.is_accomodation_need == true"
                        ><i class="fa fa-info-circle"></i> Subject to
                        availability</small
                      >
                    </label>
                    <div class="col-md-5">
                      <label class="radio-inline">
                        <input
                          type="radio"
                          :value="true"
                          v-model="step_one_form.is_accomodation_need"
                  ...
                  <label class="col-md-12">
                    (b) Applicant Bank information
                  </label>
                  <form-input
                    :label="'A/C Holder Name'"
                    :input_data="step_one_form.account_holder_name"
                    :errors="step_one_form.errors"
                    :error_attr="'account_holder_name'"
                    :placeholder="'A/C Holder Name'"
                    :required="true"
                    :label_style="'margin-left:35px;'"
                    @inputDataChanged="step_one_form.account_holder_name = $event"
                  ></form-input>
                      <form-input
                    :label="'Bank A/C No'"
                    :input_data="step_one_form.bank_ac_no"
                    :errors="step_one_form.errors"
                    :error_attr="'bank_ac_no'"
                    :placeholder="'Bank ac no'"
                    :required="true"
                    :label_style="'margin-left:35px;'"
                    @inputDataChanged="step_one_form.bank_ac_no = $event"
                  ></form-input>

                  <form-input
                    :label="'Bank Name'"
                    :input_data="step_one_form.bank_name"
                    :errors="step_one_form.errors"
                    :error_attr="'bank_name'"
                    :placeholder="'Bank name'"
                    :required="true"
                    :label_style="'margin-left:35px;'"
                    @inputDataChanged="step_one_form.bank_name = $event"
                  ></form-input>

                  <form-input
                    :label="'Branch Name'"
                    :input_data="step_one_form.branch_name"
                    :errors="step_one_form.errors"
                    :error_attr="'branch_name'"
                    :placeholder="'Branch name'"
                    :required="true"
                    :label_style="'margin-left:35px;'"
                    @inputDataChanged="step_one_form.branch_name = $event"
                  ></form-input>

                  <form-input
                    :label="'IFSC code'"
                    :input_data="step_one_form.ifsc_code"
                    :errors="step_one_form.errors"
                    :error_attr="'ifsc_code'"
                    :placeholder="'IFSC Code'"
                    :required="true"
                    :label_style="'margin-left:35px;'"
                    @inputDataChanged="step_one_form.ifsc_code = $event"
                  ></form-input>

                  <form-input
                    :label="'Mobile No'"
                    :input_data="step_one_form.bank_reg_mobile_no"
                    :errors="step_one_form.errors"
                    :error_attr="'bank_reg_mobile_no'"
                    :placeholder="'Bank Registered Mobile No'"
                    :required="true"
                    :label_style="'margin-left:35px;'"
                    @inputDataChanged="step_one_form.bank_reg_mobile_no = $event"
                  ></form-input>
          ...
          <div class="step personal_information">
            <fieldset id="personal_information">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <form-input
                    :label="'(a) C/O'"
                    :input_data="step_two_form.correspondence.co"
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_co'"
                    :placeholder="'C/O'"
                    @inputDataChanged="step_two_form.correspondence.co = $event"
                  ></form-input>

                  <form-input
                    :label="'(b) House No '"
                    :input_data="step_two_form.correspondence.house_no"
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_house_no'"
                  ...
                  <form-input
                    :label="'(c) Street Name /Locality '"
                    :input_data="
                      step_two_form.correspondence.street_name_locality
                    "
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_street_name_locality'"
                  ...
                  <form-input
                    :label="'(d) Vill/ Town '"
                    :input_data="step_two_form.correspondence.vill_town"
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_vill_town'"
                  ...
                  <form-input
                    :label="'(e) Pin/Zip Code'"
                    :input_data="step_two_form.correspondence.pin_code"
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_pin_code'"
                  ...
                  <form-input
                    :label="'(f) P.O'"
                    :input_data="step_two_form.correspondence.po"
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_po'"
                    :placeholder="'P.O'"
                    @inputDataChanged="step_two_form.correspondence.po = $event"
                  ></form-input>

                  <form-input
                    :label="'(g) District'"
                    :input_data="step_two_form.correspondence.district"
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_district'"
                  ...
                  <form-select
                    ...
                    :options="states"
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_state'"
                    :value_attr="'name'"
                    :name_attr="'name'"
                    :required="true"
                    :old_value="step_two_form.correspondence.state"
                    :old_value_attr="'name'"
                    @changedSelect="step_two_form.correspondence.state = $event"
                    v-if="!is_foreign"
                  ></form-select>
                  <form-input
                    :label="'(h) State / UT'"
                    :input_data="step_two_form.correspondence.state"
                    :errors="step_two_form.errors"
                    :error_attr="'correspondence_state'"
                    :placeholder="'State'"
                    @inputDataChanged="
                      step_two_form.correspondence.state = $event
                    "
                    v-if="is_foreign"
                  ></form-input>
                </div>
                ...
                <div class="col-md-6">
                        ...
                        <section style="float:left;">
                          <label class="radio-inline">
                            <input
                              type="radio"
                              :value="true"
                              v-model="step_two_form.is_permanent_same"
                              @change="isPermanentChanged"
                              id="is-permanent"
                            />
                  ...
                  <section>
                    <form-input
                      :label="'(a) C/O'"
                      :input_data="step_two_form.permanent.co"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_co'"
                      :placeholder="'C/O'"
                      @inputDataChanged="step_two_form.permanent.co = $event"
                    ></form-input>

                    <form-input
                      :label="'(b) House No'"
                      :input_data="step_two_form.permanent.house_no"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_house_no'"
                      :placeholder="'House No'"
                      @inputDataChanged="
                    ...
                    <form-input
                      :label="'(c) Street Name /Locality'"
                      :input_data="step_two_form.permanent.street_name_locality"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_street_name_locality'"
                      :placeholder="'House Name / locality'"
                      @inputDataChanged="
                  ...
                  <section>
                    <form-input
                      :label="'(d) Vill/ Town'"
                      :input_data="step_two_form.permanent.vill_town"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_vill_town'"
                      :placeholder="'Village / Town'"
                      @inputDataChanged="
                    ...
                    <form-input
                      :label="'(e) Pin/Zip Code'"
                      :input_data="step_two_form.permanent.pin_code"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_pin_code'"
                      :placeholder="'Pin Code'"
                      @inputDataChanged="
                    ...
                    <form-input
                      :label="'(f) P.O'"
                      :input_data="step_two_form.permanent.po"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_po'"
                      :placeholder="'P.O'"
                      @inputDataChanged="step_two_form.permanent.po = $event"
                    ></form-input>

                    <form-input
                      :label="'(g) District'"
                      :input_data="step_two_form.permanent.district"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_district'"
                      :placeholder="'District'"
                      @inputDataChanged="
                    ...
                    <form-select
                      ...
                      :options="states"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_state'"
                      :value_attr="'name'"
                      :name_attr="'name'"
                      :required="true"
                      :old_value="step_two_form.permanent.state"
                      :old_value_attr="'name'"
                      @changedSelect="step_two_form.permanent.state = $event"
                      v-if="!is_foreign"
                    ></form-select>
                    <form-input
                      :label="'(h) State / UT'"
                      :input_data="step_two_form.permanent.state"
                      :errors="step_two_form.errors"
                      :error_attr="'permanent_state'"
                      :placeholder="'State'"
                      @inputDataChanged="step_two_form.permanent.state = $event"
                      v-if="is_foreign"
                    ></form-input>
                  </section>
                </div>
                ...
                <div class="col-md-6">
                  <form-input
                    :label="'3. Contact No'"
                    :input_data="step_two_form.contact_no"
                    :errors="step_two_form.errors"
                    :error_attr="'contact_no'"
                    :placeholder="'Contact No'"
                    :disabled="true"
                    @inputDataChanged="step_two_form.contact_no = $event"
                  ></form-input>

                  <form-input
                    :label="'4. Email'"
                    :input_data="step_two_form.email"
                    :errors="step_two_form.errors"
                    :error_attr="'email'"
                    :placeholder="'Email'"
                    :disabled="true"
                    @inputDataChanged="step_two_form.email = $event"
                  ></form-input>

                  <form-input
                    :label="'5. Nationality'"
                    :input_data="step_two_form.nationality"
                    :errors="step_two_form.errors"
                    :error_attr="'nationality'"
                    :placeholder="'Nationality'"
                    :required="true"
                    @inputDataChanged="step_two_form.nationality = $event"
                  ></form-input>
                  ...
                  ></form-input> -->
                  <form-select
                    :label="'6. Place of residence'"
                    :options="place_of_residence_dropdown"
                    :errors="step_two_form.errors"
                    :error_attr="'place_residence'"
                    :value_attr="'id'"
                    :name_attr="'place_residence'"
                    :required="true"
                    :old_value="step_two_form.place_residence"
                    :old_value_attr="'id'"
                    @changedSelect="step_two_form.place_residence = $event"
                  ></form-select>
                </div>
                <div class="col-md-6" 
                    v-if="is_mba !== true">
                  <div class="panel panel-info">
                    <div class="panel-body">
                      <form-select
                        :label="'7. Select Examination Center'"
                        :options="centers"
                        :errors="step_two_form.errors"
                        :error_attr="'exam_center'"
                        :value_attr="'id'"
                        :name_attr="'center_name'"
                        :required="true"
                        :old_value="step_two_form.center"
                        :old_value_attr="'id'"
                        @changedSelect="step_two_form.center = $event"
                      ></form-select>
                    </div>
                  </div>
                </div>
            ...
            <div class="row btn-row">
              <div class="col-md-6">
                ...
                <button
                  type="button"
                  class="btn btn-success btn-sm next"
                  id="next"
                  @click="submitStepTwo"
        ...
        <div class="col-md-12">
          ...
          >
            ...
            <fieldset id="academic_details">
              ...
              <label>
                <span class="text-info">1. Qualifications (* Write <span class="text-primary">NA/Zero</span> if not available)</span>
              </label>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic10_board_name"
                          >{{
                      ...
                      <td>
                        ...
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic10_passing_year"
                          >{{
                      ...
                      <td>
                        <input
                          required
                          type="text"
                          v-model="step_three_form.academic10.class_grade"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic10_class_grade"
                          >{{
                      ...
                      <td>
                        <textarea
                          ...
                          rows="2"
                          required
                          v-model="step_three_form.academic10.subjects_taken"
                          class="form-control input-sm"
                      ...
                      <td>
                        <label class="radio-inline">
                          <input
                            ...
                            "
                            @change="academic10AppearedChanged"
                            id="is_sport_represented"
                          />
                          <span class="text-warning">Passed</span> </label
                        ><br />
                        <label class="radio-inline">
                          <input
                            type="radio"
                      ...
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic10.academic_10_total_mark"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_10_total_mark"
                          >{{ step_three_form.errors.academic_10_total_mark }}</small
                        >
                      </td>
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic10.academic_10_mark_obtained"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_10_mark_obtained"
                          >{{ step_three_form.errors.academic_10_mark_obtained }}</small
                        >
                      </td>
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic10.cgpa"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic10_cgpa"
                          >{{ step_three_form.errors.academic10_cgpa }}</small
                        >
                      </td>
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic10.marks_percentage"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic10.remarks"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic10_remarks"
                          >{{
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic12_passing_year"
                          >{{
                      ...
                      <td>
                        <input
                          required
                          type="text"
                          v-model="step_three_form.academic12.class_grade"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic12_class_grade"
                          >{{
                      ...
                      <td>
                        <textarea
                          ...
                          rows="2"
                          required
                          v-model="step_three_form.academic12.subjects_taken"
                          class="form-control input-sm"
                          placeholder="Subjects taken"
                        ></textarea>
                        <small class="text-info"
                        ...
                        <form-select
                          :label="'Stream'"
                          :options="streams"
                          :errors="step_three_form.errors"
                          style="margin-top:12px;"
                          :value_attr="'name'"
                          :name_attr="'name'"
                          :required="false"
                          :old_value="step_three_form.academic12.stream"
                          :old_value_attr="'name'"
                          @changedSelect="
                        ...
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic12_stream"
                          >{{ step_three_form.errors.academic12_stream }}</small
                        >
                        <div v-if="initial_step.is_mca == true">
                          <strong>Marks in mathematics</strong> <input
                          required
                          type="number"
                      ...
                      <td>
                        <label class="radio-inline">
                          <input
                            ...
                            "
                            @change="academic12AppearedChanged"
                            id="is_sport_represented"
                          />
                          <span class="text-warning">Passed</span> </label
                        ><br />
                      ...
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic12.academic_12_total_mark"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_12_total_mark"
                          >{{ step_three_form.errors.academic_12_total_mark }}</small
                        >
                      </td>
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic12.academic_12_mark_obtained"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_12_mark_obtained"
                          >{{ step_three_form.errors.academic_12_mark_obtained }}</small
                        >
                      </td>
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic12.cgpa"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic12_cgpa"
                          >{{ step_three_form.errors.academic12_cgpa }}</small
                        >
                      </td>
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic12.marks_percentage"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic12.remarks"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic12_remarks"
                          >{{
                    ...
                    <tr v-if="show_ug == true">
                      <th>
                        <form-select
                          ...
                          :errors="step_three_form.errors"
                          :error_attr="'academic_bachelor_degree'"
                          :value_attr="'name'"
                          :name_attr="'name'"
                          :required="true"
                          :is_break_label="true"
                          :old_value="step_three_form.academic_bachelor.degree"
                          :old_value_attr="'name'"
                          @changedSelect="
                      ...
                      <td>
                        ...
                        /> -->
                       <select
                            v-model="step_three_form.academic_bachelor.passing_year"
                            class="form-control input-sm"
                            required
                          >
                            <option value selected disabled>--SELECT--</option>
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic_bachelor.major"
                          class="form-control input-sm input-sm"
                          placeholder="Major if any"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_bachelor_major"
                          >{{
                          ...
                          <input
                            ...
                            v-model="
                              step_three_form.academic_bachelor
                                .is_passed_appearing
                            "
                            @change="academicBachelorAppearedChanged"
                            id="is_sport_represented"
                          />
                          <span class="text-warning">Passed</span> </label
                        ><br />
                      ...
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic_bachelor.academic_graduation_total_mark"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_graduation_total_mark"
                          >{{
                      ...
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic_bachelor.academic_graduation_mark_obtained"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_graduation_mark_obtained"
                          >{{
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic_bachelor.cgpa"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_bachelor_cgpa"
                          >{{
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic_bachelor.remarks"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                    ...
                    <tr v-if="show_pg == true">
                      <th>
                        <form-select
                          ...
                          "
                          :options="post_degrees"
                          :errors="step_three_form.errors"
                          :error_attr="'master_degree'"
                          :value_attr="'name'"
                          :name_attr="'name'"
                          :required="is_mtech ? false : true"
                          :is_break_label="true"
                          :old_value="
                      ...
                      <td>
                        ...
                        /> -->
                        <select
                            v-model="step_three_form.academic_post_graduate.passing_year"
                            class="form-control input-sm"
                            required
                          >
                            <option value selected disabled>--SELECT--</option>
                          ...
                          <input
                            ...
                            v-model="
                              step_three_form.academic_post_graduate
                                .is_passed_appearing
                            "
                            @change="academicPostAppearedChanged"
                            id="is_sport_represented"
                          />
                          <span class="text-warning">Passed</span> </label
                        ><br />
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic_post_graduate.cgpa"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                    ...
                    <tr v-if="is_lateral == true">
                      ...
                      <td>
                        ...
                        /> -->
                        <select
                            v-model="step_three_form.academic_diploma.passing_year"
                            class="form-control input-sm"
                            required
                          >
                            <option value selected disabled>--SELECT--</option>
                      ...
                      <td>
                        <input
                          required
                          type="text"
                          v-model="step_three_form.academic_diploma.class_grade"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          ...
                          <input
                            ...
                            v-model="
                              step_three_form.academic_diploma
                                .is_passed_appearing
                            "
                            @change="academicDiplomaAppearedChanged"
                            id="is_sport_represented"
                          />
                          <span class="text-warning">Paased</span> </label
                        ><br />
                        <label class="radio-inline">
                          <input
                            type="radio"
                      ...
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic_diploma.academic_diploma_total_mark"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_diploma_total_mark"
                          >{{
                      ...
                      <td>
                        <input
                          type="number"
                          v-model="step_three_form.academic_diploma.academic_diploma_mark_obtained"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_diploma_mark_obtained"
                          >{{
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic_diploma.cgpa"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_diploma_cgpa"
                          >{{
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="step_three_form.academic_diploma.remarks"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                          v-if="step_three_form.errors.academic_diploma_remarks"
                          >{{
              ...
              <label>
                <span class="text-info">Pre-Qualifying/ Semester wise/ Year wise/ Any Other Qualification Marks of Qualifying Exam (Please enter information here by clicking Add New button)</span>
              </label>
              <button
                type="button"
              ...
              >
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr
                      v-for="(qual, index) in step_three_form
                    ...
                    >
                      ...
                      <td>
                        <input
                          type="text"
                          v-model.number="qual.total_mark"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                      ...
                      <td>
                        <input
                          type="text"
                          v-model.number="qual.mark_obtained"
                          class="form-control input-sm input-sm"
                        />
                        <small
                          class="text-danger"
                      ...
                      <td>
                        <button
                          ...
                          @click="removeQualification(qual)"
                        >
                          Remove
                        </button>
                      </td>
              ...
              <hr />
              <div
                class="table-responsive qualifing"
              ...
              <div class="alert alert-info">
                ...
                <ul>
                  <li>For Mark based system:
                    <ul>
                      ...
                      <li>Column A : Total Marks in the subject ( English/Physics/Chemistry/Mathematics/Biology/Statistics)</li>
                      <li>Column B : Marks secured in the subject ( English/Physics/Chemistry/Mathematics/Biology/Statistics)</li>
                      <li>Column C : Percentage  in the subject ( English/Physics/Chemistry/Mathematics/Biology/Statistics)</li>
                    </ul>
                  ...
                  <li>For Grade based system:
                    <ul>
                      <li>Column A : Total Marks in the subject ( English/Physics/Chemistry/Mathematics/Biology/Statistics)</li>
                      <li>Column B : Grade secured  in the subject ( English/Physics/Chemistry/Mathematics/Biology/Statistics)</li>
                      <li>Column C : Percentage  in the subject ( English/Physics/Chemistry/Mathematics/Biology/Statistics) [To be calculated based on the percentage formula set by the Council / Board. Upload the percentile conversion formula in the Upload Document section (Compulsory)]</li>
                    </ul>
                ...
                <table class="table table-bordered table-striped marks_columns_min_width">
                  <thead>
                    <th>Subject</th>
                    <th>A</th>
                    <th>B</th>
                  ...
                  <tbody>
                    <tr v-if="is_integrated_english">
                      <th >English in 10<sup>th</sup> (Core/Compulsory)</th>
                      <td>
                        <input type="number" v-model.number="step_three_form.qualifing.english_mark_10_total_mark" class="form-control input-sm input-sm" maxlength="4"
                          minlength="2" required/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.english_mark_10_total_mark"
                          >{{
                      ...
                      <td>
                        <input type="text" v-model="step_three_form.qualifing.english_mark_10_grade" class="form-control input-sm input-sm" maxlength="10"
                          minlength="2" required/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.english_mark_10_grade"
                          >{{
                      ...
                      <td>
                        <input type="number" v-model.number="step_three_form.qualifing.english_mark_10" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2" required/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.english_mark_10"
                          >{{
                    ...
                    <tr  v-if="!is_integrated_english">
                      ...
                      <td>
                        <input type="number" v-model.number="step_three_form.qualifing.physics_total_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2" required/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.physics_total_mark"
                          >{{
                      ...
                      <td>
                        <input type="text" v-model="step_three_form.qualifing.physics_grade" class="form-control input-sm input-sm" maxlength="3" required/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.physics_grade"
                          >{{
                      ...
                      <td>
                        <input type="number" v-model.number="step_three_form.qualifing.physics_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2" required/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.physics_mark"
                          >{{
                    ...
                    <tr v-if="!is_integrated_english">
                      ...
                      <td>
                        <input type="number" v-model.number="step_three_form.qualifing.chemistry_total_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2" required/>
                           <small
                          class="text-danger"
                          v-if="step_three_form.errors.chemistry_total_mark"
                          >{{
                      ...
                      <td>
                        <input type="text" v-model="step_three_form.qualifing.chemistry_grade" class="form-control input-sm input-sm" maxlength="3" required/>
                           <small
                          class="text-danger"
                          v-if="step_three_form.errors.chemistry_grade"
                          >{{
                      ...
                      <td>
                        <input type="number" v-model.number="step_three_form.qualifing.chemistry_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2" required/>
                           <small
                          class="text-danger"
                          v-if="step_three_form.errors.chemistry_mark"
                          >{{
                    ...
                    <tr v-if="!is_integrated_english">
                      ...
                      <td>
                        <input type="number" required  v-model="step_three_form.qualifing.mathematics_total_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2"/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.mathematics_total_mark"
                          >{{
                      ...
                      <td>
                        <input type="text" required  v-model="step_three_form.qualifing.mathematics_grade" class="form-control input-sm input-sm" maxlength="3"/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.mathematics_grade"
                          >{{
                      ...
                      <td>
                        <input type="number" required  v-model="step_three_form.qualifing.mathematics_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2"/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.mathematics_mark"
                          >{{
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" required v-model.number="step_three_form.qualifing.english_total_mark" class="form-control input-sm input-sm" maxlength="4" />
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.english_total_mark"
                          >{{
                      ...
                      <td>
                        <input type="text" required v-model="step_three_form.qualifing.english_grade" class="form-control input-sm input-sm" maxlength="5" />
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.english_grade"
                          >{{
                      ...
                      <td>
                        <input type="number" required v-model.number="step_three_form.qualifing.english_mark" class="form-control input-sm input-sm" maxlength="3" />
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.english_mark"
                          >{{
                    ...
                    <tr v-if="!is_integrated_english && is_integrated">
                      <th >Statistics in 10+2</th>
                      
                      <td>
                        <input type="number" required v-model.number="step_three_form.qualifing.statistics_total_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2"/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.statistics_total_mark"
                          >{{
                      ...
                      <td>
                        <input type="text" required v-model="step_three_form.qualifing.statistics_grade" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2"/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.statistics_grade"
                          >{{
                      ...
                      <td>
                        <input type="number" required v-model.number="step_three_form.qualifing.statistics_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2"/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.statistics_mark"
                          >{{
                    ...
                    <tr v-if="!is_integrated_english && is_integrated">
                      ...
                      <td v-if="!is_integrated_english">
                        <input type="number" required v-model.number="step_three_form.qualifing.biology_total_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2"/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.biology_total_mark"
                          >{{
                      ...
                      <td>
                        <input type="text" required v-model="step_three_form.qualifing.biology_grade" class="form-control input-sm input-sm" maxlength="3" />
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.biology_grade"
                          >{{
                            step_three_form.errors.biology_grade
                          }}</small
                        >
                      </td>
                      <td v-if="!is_integrated_english && is_integrated">
                        <input type="number" required v-model.number="step_three_form.qualifing.biology_mark" class="form-control input-sm input-sm" maxlength="3"
                          minlength="2"/>
                          <small
                          class="text-danger"
                          v-if="step_three_form.errors.biology_mark"
                          >{{
              ...
              <div class="row jee" v-if="initial_step.is_btech == true">
                <div class="col-md-12">
                  <label>
                    ...
                    <small>(If you donot have the JEE Admit Card or if you have multiple JEE Roll Nos, please enter 'NA')</small>
                  </label>
                  <div class="panel panel-default">
                    <div class="panel-body">
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label
                              for="jee_roll"
                              class="col-md-4 control-label text-right margin-label"
                            >
                              (a) JEE Main Roll No:
                              <!-- <span class="text-danger">*</span> -->
                            </label>
                            <div class="col-md-7">
                              <input
                                type="text"
                                v-model="step_three_form.jee.roll_no"
                                class="form-control input-sm input-sm"
                              />
                              <strong class="text-info small">Enter NA if Roll No not available.</strong>
                              <small
                                class="text-danger"
                                v-if="step_three_form.errors.jee_roll_no"
                                >{{ step_three_form.errors.jee_roll_no }}</small
                              >
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-md-7">
                              <input
                                type="text"
                                v-model="step_three_form.jee.form_no"
                                class="form-control input-sm input-sm"
                              />
                              <small
                                class="text-danger"
                                v-if="step_three_form.errors.jee_form_no"
                                >{{ step_three_form.errors.jee_form_no }}</small
                              >
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-md-7">
                              <input
                                type="text"
                                v-model="step_three_form.jee.year"
                                class="form-control input-sm input-sm"
                              />
                              <small
                                class="text-danger"
                                v-if="step_three_form.errors.jee_year"
                                >{{ step_three_form.errors.jee_year }}</small
                              >
                            </div>
                          </div>
                        </div>
              ...
              <div class="row mba" v-if="is_mba">
                <div class="col-md-12">
                  <label>
                    3. CAT/MAT/ATMA/XAT Details (only for MBA student) (if not enter <span class="text-info">NA, Zero</span>)
                  </label>
                  <div class="panel panel-default">
                    <div class="panel-body">
                      <div class="row">
                        <div class="col-sm-12">
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              <tr v-for="(data, index) in step_three_form.mba_exam_data.details"
                                  :key="index">
                                <td>
                                  <strong>{{data.name_of_the_exam}}</strong>
                                </td>
                                <td>
                                  <input type="text"  v-model="data.registration_no" class="form-control input-sm" value="" required/>
                                  <small
                                    class="text-danger"
                                ...
                                <td>
                                  <input type="number"  v-model="data.score_obtained" class="form-control input-sm text-right" required/>
                                  <small
                                    class="text-danger"
					   ...
					   <h3>Work Experience</h3>
					   	<table class="table table-bordered">
							...
							<tbody>
								...
								<tr v-for="item in step_three_form.work_experience"
								 @key="item.key">
									<td>
										<input v-model="item.organization"  type="text" name="exp_1" class="form-control input-sm" placeholder="organization name"/>
									</td>
									<td>
										<input  v-model="item.designation"  type="text"  name="exp_1" class="form-control input-sm" placeholder="designation"/>
									</td>
									<td>
									...
									<td>
										<textarea v-model="item.details" class="form-control input-sm" placeholder="detail"></textarea>
									</td>
								</tr>
							</tbody>
						</table>
                    ...
                    <div class="col-md-6">
                      <div class="form-group" v-if="is_foreign == false">
                        <label for="is_sport_represented" class="col-md-7">
                          <span v-if="initial_step.is_btech == true">4</span>
                          <span v-else>2</span>. Have you represented the
                          Country/State in any sport?
                        </label>
                        <div class="col-md-5">
                          <div class="row">
                            <div class="col-md-12">
                              <label class="radio-inline">
                                <input
                                  type="radio"
                                  :value="true"
                                  v-model="step_three_form.is_sport_represented"
                                  id="is_sport_represented"
                                />
                                <span class="text-warning">Yes</span>
                              </label>
                          ...
                          <!-- <div class="row" v-if="step_three_form.is_sport_represented == true">
                            <div class="col-md-10">
                               <input
                                type="text"
                                v-model="step_three_form.sport_played"
                                class="form-control input-sm input-sm"
                                placeholder="Please specify"
                              />
                              <small
                                class="text-danger"
                                v-if="step_three_form.errors.sport_played"
                                >{{
                                  step_one_form.errors.sport_played
                                }}</small
                              >
                            </div>
                          </div> -->
                      ...
                      <form-input
                        :label="'Please Specify'"
                        :input_data="step_three_form.sport_played"
                        :errors="step_three_form.errors"
                        ...
                        "
                        v-if="step_three_form.is_sport_represented == true"
                      ></form-input>
                      <div class="form-group">
                        <label for="is_prizes_distinction" class="col-md-7">
                          <span v-if="initial_step.is_btech == true">4</span>
                          <span v-else>3</span> . Academic
                        ...
                        <div class="col-md-5">
                          <label class="radio-inline">
                            <input
                              type="radio"
                              :value="true"
                              v-model="step_three_form.is_prizes_distinction"
                      ...
                      <div class="form-group">
                        <label for="other_information" class="col-md-7">
                          <span>4</span> . Other information worth
                          mentioning including publications, if any ?
                          <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-5">
                          <textarea
                            ...
                            rows="2"
                            required
                            v-model="step_three_form.other_information"
                            class="form-control input-sm"
                          ></textarea>
                          <small class="text-info"
                            ><strong>{{
                          ...
                          <small
                            class="text-danger"
                            v-if="step_three_form.errors.other_information"
                            >{{
                      ...
                      <div class="form-group" v-if="is_phd">
                          <label for="proposed_area_of_research" class="col-md-7">
                              <span v-if="is_phd == true">5</span>
                              <span v-else>4</span> . Proposed area of research ?
                              <span class="text-danger">*</span>
                          </label>
                          <div class="col-md-5">
                              <table>
                              <tr v-for="(value, index) in step_three_form.proposed_area_of_research"
                                      :key="index">
                                    <td style="padding-right:3px;">{{index+1 }}. </td>
                                    <td>
                                    <input style="padding-bottom:2px" type="text" v-model="value.data" class="form-control input-sm" value="" required/>
                                    <small
                                      class="text-danger"
                                  ...
                                  <td>
                                  <button type="button" @click="removePurposeofResearch(index)" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove-sign"></i></button>
                                      </td>
                              </tr>
                              </table>
                              <button type="button" class="btn btn-xs btn-info" @click="addMorePurposeofResearch()"><i class="glyphicon glyphicon-plus-sign"></i> Add More </button>
                          </div>
                      </div>
                      <div class="form-group is_master_in _design" v-if="is_master_in_design">
                        <label for="ceed_score" class="col-md-7">
                          CEED score
                          <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-5">
                          <input
                            required
                            v-model="step_three_form.ceed_score"
                            class="form-control input-sm"
                            placeholder="ceed score"
                           />
                          <small
                            class="text-danger"
                            v-if="step_three_form.errors.ceed_score"
                            >{{
                      ...
                      <div class="form-group" v-if="is_phd">
                        <label for="proposed_area_of_research" class="col-md-7">
                          <span v-if="is_phd == true">6</span>
                          <span v-else>4</span> . Qualified National level test?
                        </label>
                        <div class="col-md-5">
                          <select
                            v-model="step_three_form.qualified_national_level_test"
                            class="form-control input-sm"
                            required
                          >
                            <option value selected disabled>--SELECT--</option>
                            <option
                              :value="test_exam"
                              :key="test_exam"
                              v-for="test_exam in qualified_national_level_test"
                              >{{ test_exam }}</option
                            >
                          </select>                          
                          <small
                            class="text-danger"
                            v-if="step_three_form.errors.qualified_national_level_test"
                            >{{
                      ...
                      <div class="form-group"  v-if="is_phd">
                        <label for="is_punished" class="col-md-7">
                          7. Qualified national level test mark
                          <small class="text-muted">(If not available enter NA)</small>
                        </label>
                        <div class="col-md-5">
                            <input
                              type="text"
                              v-model="step_three_form.qualified_national_level_test_mark"
                              id="qualified_national_level_test_mark"
                              class="form-control"
                            />
                            <small
                            class="text-danger"
                            v-if="step_three_form.errors.qualified_national_level_test_mark"
                            >{{
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="is_debarred" class="col-md-7">
                          <span v-if="initial_step.is_btech == true">6</span>
                          <span v-else>5</span>. Were you <br />(a) Debarred
                        ...
                        <div class="col-md-5">
                          <label class="radio-inline">
                            <input
                              type="radio"
                              :value="true"
                              v-model="step_three_form.is_debarred"
                              id="is_debarred"
                            />
                            <span class="text-warning">Yes</span>
                          </label>
                        ...
                        <div class="col-md-5">
                          <label class="radio-inline">
                            <input
                              type="radio"
                              :value="true"
                              v-model="step_three_form.is_punished"
                              id="is_punished"
                            />
                            <span class="text-warning">Yes</span>
                          </label>
                      ...
                      >
                        ...
                        <div class="col-md-12">
                          <textarea
                            ...
                            rows="2"
                            required
                            v-model="step_three_form.furnish_details"
                            class="form-control input-sm"
                          ></textarea>
                          <small class="text-info"
                            ><strong>{{
                          ...
                          <small
                            class="text-danger"
                            v-if="step_three_form.errors.furnish_details"
                            >{{ step_three_form.errors.furnish_details }}</small
                          >
                        </div>
                      </div>
                    </div>
              ...
              <div class="row btn-row">
                <div class="col-md-6">
                  ...
                  <button
                    ...
                    id="next"
                    @click="goToStepFour"
                    v-if="step_three_form.submitted == true"
                  >
                    GO NEXT
                    <i class="fa fa-chevron-right"></i>
                  </button>
        ...
        >
          ...
          <div class="step personal_information">
            <fieldset id="personal_information">
              ...
              <div class="row">
                <div class="col-md-6">
                  <section v-if="this.step_one_form.caste != '1'">
                    <div class="form-group">
                      <label for="document_undertaking" class="col-md-4 margin-label">
                        Undertaking for Category Certificate <strong class="text-danger">*</strong><small class="text-muted">(for all programmes)</small>
                        :
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                            <input
                              ...
                              ref="undertaking"
                              class="form-control input-sm input-sm"
                              @change="undertakingFileChanged"
                              accept=".jpg,.jpeg,.png"
                            />
                          <div class="input-group-btn">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('undertaking', 'undertaking')">
                        ...
                        <strong
                          ...
                          v-if="step_four_form.errors.undertaking"
                        >{{ step_four_form.errors.undertaking }}</strong>
                        <!-- errors2 for create validation -->
                        <strong
                          class="text-danger" style="display:block;"
                          v-if="step_four_form.errors2.undertaking"
                        >{{ step_four_form.errors2.undertaking }}</strong>
                      </div>
                    </div>
                  </section>
                    ...
                    <div class="form-group" v-if="is_mbbt || initial_step.is_btech">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                            ...
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_prc', 'prc')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.prc"
                          >{{ step_four_form.errors.prc }}</strong
                        >
                      </div>
                    </div>
                    <div class="form-group" v-if="!is_integrated && !is_mbbt">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                            ...
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_gate_score_card', 'gate_score_card')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.gate_score_card"
                          >{{ step_four_form.errors.gate_score_card }}</strong
                        >
                      </div>
                    </div>
                    <div class="form-group"  v-if="this.step_one_form.caste != '1'">
                      <label for="document_caste" class="col-md-4 margin-label"
                        >Category Certificate:</label
                      >
                      <div class="col-md-7">
                        <div class="input-group">
                            <input
                            ...
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_caste', 'caste_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.caste_certificate"
                          >{{ step_four_form.errors.caste_certificate }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.document_caste"
                          >{{ step_four_form.errors2.document_caste }}</strong
                        >
                      </div>
                    </div>
                    <div class="form-group" v-if="is_mbbt">
                      <label for="document_caste" class="col-md-4 margin-label"
                        >GAT-B score card: <strong class="text-danger">*</strong></label
                      >
                      <div class="col-md-7">
                        <div class="input-group">
                            <input
                              type="file"
                              ref="gate_b_score_card"
                              class="form-control input-sm input-sm"
                              @change="gateBScoreCardChange"
                              accept=".jpg,.jpeg,.png"
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('gate_b_score_card', 'gate_b_score_card')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <small class="text-info"
                          ><strong
                            >Max-size: 5MB , File type: JPEG,JPG, PNG</strong
                          >
                        </small>
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.gate_b_score_card"
                          >{{ step_four_form.errors.gate_b_score_card }}</strong
                        >
                      </div>
                    </div>
                    
                    <div class="form-group" v-if="is_master_in_design">
                      <label for="ceed_score_card" class="col-md-4 margin-label"
                        >CEED score card (only for master of Design) <strong class="text-danger">*</strong>:</label
                      >
                      <div class="col-md-7">
                        <div class="input-group">
                             <input
                              ...
                              ref="ceed_score_card"
                              class="form-control input-sm input-sm"
                              @change="CeedScoreCardChange"
                              accept=".jpg,.jpeg,.png"
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('ceed_score_card', 'ceed_score_card')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.ceed_score_card"
                          >{{ step_four_form.errors.ceed_score_card }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.ceed_score_card"
                          >{{ step_four_form.errors2.ceed_score_card }}</strong
                        >
                      </div>
                    </div>
                    <div class="form-group" v-if="is_master_in_design">
                      <label for="portfolio" class="col-md-4 margin-label"
                        >Portfolio (only for master of Design) <strong class="text-danger">* (Only PDF Allowed)</strong>:</label
                      >
                      <div class="col-md-7">
                        <div class="input-group">
                            <input
                            ...
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('portfolio_file', 'portfolio')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <small class="text-info"
                          ><strong
                            >Max-size: 5MB , File type: PDF</strong
                          >
                        </small>
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.portfolio"
                          >{{ step_four_form.errors.portfolio }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.portfolio_file"
                          >{{ step_four_form.errors2.portfolio_file }}</strong
                        >
                      </div>
                    </div>
                    <div class="form-group" v-if="step_one_form.is_bpl == true">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                            ...
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_bpl', 'bpl_card')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.bpl_card"
                          >{{ step_four_form.errors.bpl_card }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.document_bpl"
                          >{{ step_four_form.errors2.document_bpl }}</strong
                        >
                      </div>
                    </div>
                    <div class="form-group" v-if="is_ncl == true">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                            ...
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_obc_ncl', 'obc_ncl')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.obc_ncl"
                          >{{ step_four_form.errors.obc_ncl }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.document_obc_ncl"
                          >{{ step_four_form.errors2.document_obc_ncl }}</strong
                        >
                      </div>
                    </div>
                    <!-- <div class="form-group" v-if="step_one_form.caste == '2'">
                      <label for="document_ews" class="col-md-4 margin-label">
                        EWS Certificate :
                        <span class="text-danger">*</span>
                      </label>
                      <div class="col-md-7">
                        <input
                          ...
                          ref="document_ews"
                          class="form-control input-sm input-sm"
                          @change="ewsFileChanged"
                          accept=".jpg,.jpeg,.png"
                        />
                        <small class="text-info"><strong>Max-size: 1MB , File type: JPEG,JPG, PNG</strong> </small>
                        <small
                          class="text-danger"
                          v-if="step_four_form.errors.ews_certificate"
                          >{{ step_four_form.errors.ews_certificate }}</small
                        >
                      </div>
                    </div> -->
                  </section>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                            ...
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('passport', 'passport')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.passport"
                          >{{ step_four_form.errors.passport }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.document_passport"
                          >{{ step_four_form.errors2.document_passport }}</strong
                        >
                      </div>
                    </div>
                  </section>
                  ...
                  >
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            ...
                            />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_sport_representation', 'sport_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                      ...
                      <strong 
                        class="text-danger" style="display:block"
                        v-if="step_four_form.errors.sport_certificate"
                        >{{ step_four_form.errors.sport_certificate }}</strong
                      >
                      <strong
                        class="text-danger" style="display:block"
                        v-if="
                  ...
                  <div class="form-group" v-if="step_one_form.is_pwd == true">
                    ...
                    <div class="col-md-7">
                      <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_pwd', 'pwd_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                      ...
                      <strong
                        class="text-danger" style="display:block"
                        v-if="step_four_form.errors.pwd_certificate"
                        >{{ step_four_form.errors.pwd_certificate }}</strong
                      >
                      <strong 
                        class="text-danger" style="display:block"
                        v-if="step_four_form.errors2.document_pwd"
                        >{{ step_four_form.errors2.document_pwd }}</strong
                      >
                    </div>
                  </div>
                  ...
                  <div
                    class="form-group"
                    v-if="step_one_form.is_employed == true && is_mba == false"
                  >
                    <label for="document_noc" class="col-md-4 margin-label">
                      NOC {{step_one_form.is_employed}}:
                      <span class="text-danger">*</span>
                    </label>
                    <div class="col-md-7">
                      <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_noc', 'noc_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                      ...
                      <strong
                        class="text-danger" style="display:block"
                        v-if="step_four_form.errors.noc_certificate"
                        >{{ step_four_form.errors.noc_certificate }}</strong
                      >
                      <strong
                        class="text-danger" style="display:block"
                        v-if="step_four_form.errors2.document_noc"
                        >{{ step_four_form.errors2.document_noc }}</strong
                      >
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <section>
                    <div class="form-group">
                      <label for="document_undertaking" class="col-md-4 margin-label">
                        Undertaking for (Passed/Appeared) <strong class="text-danger">*</strong><small class="text-muted">(for all programmes)</small>
                        :
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input
                          type="file"
                          ref="undertaking_pass_appear"
                          class="form-control input-sm input-sm"
                          @change="undertakingPassAppearFileChanged"
                          accept=".jpg,.jpeg,.png"
                        />
                          <div class="input-group-btn">
                           <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('undertaking_pass_appear', 'undertaking_pass_appear')">
        <i class="fa fa-upload"></i> Upload
</button>
                          </div>
                        </div>
                        ...
                        >{{ step_four_form.errors.undertaking_pass_appear }}</strong>
                        <!-- errors2 for create validation -->
                      </div>
                    </div>
                  </section>
                  <section v-if="!is_foreign">
                    <div
                      class="form-group"
                      v-if="initial_step.is_btech == true"
                    >
                      <label
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_admit_jee', 'jee_admit')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                        ...
                        <strong class="small text-warning">Please insert undertaking if admit card is not available.</strong>
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.jee_admit"
                          >{{ step_four_form.errors.jee_admit }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.document_admit_jee"
                          >{{ step_four_form.errors2.document_admit_jee }}</strong
                        >
                      </div>
                    </div>
                    ...
                    <div class="form-group" v-if="is_phd">
                      <label
                        ...
                        class="col-md-4 margin-label"
                      >
                        SLET/JRF/MPhil Certificate (if applicable) :
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_net_slet', 'net_slet_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_ex_servicement', 'ex_serviceman_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('driving_license', 'driving_license')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.driving_license"
                          >{{ step_four_form.errors.driving_license }}</strong
                        >
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        ...
                        />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('ssn_equivalent', 'ssn_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.ssn_certificate"
                          >{{ step_four_form.errors.ssn_certificate }}</strong
                        >
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('passing_certificate', 'passing_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.passing_certificate"
                          >{{
                            step_four_form.errors.passing_certificate
                          }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('marksheet', 'qualifying_marksheet')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                        ...
                        <strong
                          class="text-danger" style="display:block"
                          v-if="step_four_form.errors.qualifying_marksheet"
                          >{{
                            step_four_form.errors.qualifying_marksheet
                          }}</strong
                        >
                        <strong
                          class="text-danger" style="display:block"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('english_proficiency_certificate', 'english_proficiency_certificate')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <div class="input-group">
                          ...
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('additional_document', 'document_additional')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                      ...
                      <small class="text-info">
						  <strong>Max-size: 1MB , File type: JPEG,JPG, PNG</strong>
                      </small>
                      <strong
                        class="text-danger" style="display:block"
                        v-if="step_four_form.errors.additional_document"
                        >{{ step_four_form.errors.additional_document }}</strong
                      >
                    </div>
                  </div>
                </div>
				...
				<div class="clearfix"></div>
              	<div class="row" v-if="is_mba">
					...
					<hr />
					<div class="col-md-6"
					v-for="mba_exam in mba_exams"
					@key="mba_exam+'_document'">
						<div class="form-group">
                ...
                <div class="input-group">
                    <input
                      type="file"
                      class="form-control input-sm input-sm"
                      @change="anyDcoumentsChange($event, mba_exam)"
                      accept=".jpg,.jpeg,.png"
                    />
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="input-group">
                                <input
                                  type="file"
                                  ref="document_passport_photo"
                                  class="form-control input-sm input-sm"
                                  @change="passportPhotoFileChanged"
                                  accept=".jpg,.jpeg,.png"
                                />
                              <div class="input-group-btn">
                                <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_passport_photo', 'passport_photo')">
        <i class="fa fa-upload"></i> Upload
</button>
                              </div>
                            </div>
                              ...
                              <small class="text-info"
                                ><strong
                                  >Max-size: 100KB | File type: JPEG,JPG, PNG |
                              ...
                              <strong
                                class="text-danger" style="display:block"
                                v-if="step_four_form.errors.passport_photo"
                                >{{
                          ...
                          <div
                            class="row"
                            v-if="step_four_form.passport_photo_url"
                          >
                            <div class="col-md-12">
                              <div class="image">
                                <img
                                  :src="step_four_form.passport_photo_url"
                                  alt="Passport Photo"
                                  width="100%"
                                />
                              </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                       <div class="input-group">
                          <input
                            type="file"
                            ref="document_signature"
                            class="form-control input-sm input-sm"
                            @change="signatureFileChanged"
                            accept=".jpg,.jpeg,.png"
                          />
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress" @click="uploadSingleFile('document_signature', 'signature')">
        <i class="fa fa-upload"></i> Upload
</button>
                        </div>
                      </div>
                      ...
                      <small class="text-info"
                        ><strong
                          >Height:150px , Width:200px , Max Size : 100KB <br />
                          File Type: PNG/JPEG/JPG
                        </strong></small
                      >
                      <strong
                        class="text-danger" style="display:block"
                        v-if="step_four_form.errors.signature"
                        >{{ step_four_form.errors.signature }}</strong
                      >
                      <strong
                        class="text-danger" style="display:block"
                        v-if="step_four_form.errors2.document_signature"
                        >{{ step_four_form.errors2.document_signature }}</strong
                      >
                    </div>
                  </div>
                </div>
                        ...
                        <div class="col-md-7">
                          <label class="radio-inline">
                            <input
                              type="radio"
                              :value="true"
                              v-model="step_four_form.is_accepted"
                              id="is_ex_serviceman"
                            />
                            <span class="text-warning">Yes</span>
                          </label>
...
export default {
  ...
  props: ["mode", "application_id", "count", "create_app_id"],
  data() {
    return {
      // base_url: "https://www.tezuadmissions.in/public",
      // base_url: "https://www.tezuadmissions.in/demo/public",
      ...
      step_three_form: {
        ...
        academic10: {
          ...
          academic_10_total_mark: 0.0,
          academic_10_mark_obtained: 0.0,
  ...
  computed: {
    ...
    isAllowNext() {
      console.log("okkkkk");
      if (this.is_sub_preference == true) {
        if (
          this.isCheckedNone == true ||
          this.isCheckedPreferenceSelected == false
        ) {
          return false;
        } else {
          return true;
        }
      } else if (this.is_preference == true) {
        if (
          this.isCheckedNonePreference == true ||
          this.isCheckedPreferenceSelected == false
        ) {
          return false;
        } else {
  ...
  mounted() {
	...
	this.step_three_form.work_experience = [1,2,3].map(id => {
		return {
			key: id+'workexp',
			organization: "",
			designation: "",
  ...
  methods: {
    ...
    loadOldApplication(id) {
      axios({
        ...
        console.log(response.data.program_list);
        ...
        if(old_programme.course_id  == 37){
          ...
          console.log(this.initial_step.is_mca);
        }
        ...
        this.initial_step.is_btech = old_app.is_btech;
    ...
    casteCertificateChanged() {
      this.step_four_form.document_caste = this.$refs.document_caste.files[0];
    },
    bplFileChanged() {
      this.step_four_form.document_bpl = this.$refs.document_bpl.files[0];
    },
    obcFileChanged() {
      this.step_four_form.document_obc_ncl = this.$refs.document_obc_ncl.files[0];
    },
    ...
    passportFileChanged() {
      this.step_four_form.document_passport = this.$refs.passport.files[0];
    },
    drivingLicenseFileChanged() {
      this.step_four_form.document_driving_license = this.$refs.driving_license.files[0];
    },
    ssnFileChanged() {
      this.step_four_form.document_ssn_equivalent = this.$refs.ssn_equivalent.files[0];
    },
    passingCertificateFileChanged() {
      this.step_four_form.document_passing_certificate = this.$refs.passing_certificate.files[0];
    },
    markSheetFileChanged() {
      this.step_four_form.document_marksheet = this.$refs.marksheet.files[0];
    },
    ...
    submitStepOne() {
      ...
      console.log(formdata.applied_courses);
      // axios({
      //   method: "post",
    ...
    updateStepOne() {
      ...
      axios({
        ...
        .catch(error => {
          ...
          this.step_one_form.updating = false;
          this.step_one_form.errors = error.response.data.errors;
          this.alertMessage("danger", "Failed to update !!");
        })
        .then(() => {
          this.step_one_form.updating = false;
        });
    ...
    submitStepFour() {
      ...
      if (stepf.document_caste) {
        formdata.append("caste_certificate", stepf.document_caste);
      }
      if (stepf.document_bpl) {
        formdata.append("bpl_card", stepf.document_bpl);
      }
      if (stepf.document_obc_ncl) {
        formdata.append("obc_ncl", stepf.document_obc_ncl);
      }
      ...
      if (stepf.document_admit_jee) {
        formdata.append("jee_admit", stepf.document_admit_jee);
      }
      ...
      if (stepf.document_passport) {
        formdata.append("passport", stepf.document_passport);
      }
      if (stepf.document_driving_license) {
        formdata.append("driving_license", stepf.document_driving_license);
      }
      if (stepf.document_ssn_equivalent) {
        formdata.append("ssn_certificate", stepf.document_ssn_equivalent);
      }
      ...
      if (stepf.document_marksheet) {
        formdata.append("qualifying_marksheet", stepf.document_marksheet);
      }
    ...
    checkCourse(course) {
      if (course.is_checked == false) {
        ...
        console.log(count);
        if (count < this.initial_step.pref_limit) {
    ...
    preferenceChanged(event, course_id) {
      ...
      for (var i = 0; i < courses.length; i++) {
        ...
        if (course.id == course_id) continue;
        if (course.preference != 0) {
          if (course.preference == pref_value) {
            this.initial_step.preference_error =
    ...
    courseTypeChanged() {
      ...
      this.initial_step.is_btech =
        this.initial_step.course_type.code == "BTECH" ? true : false;
    ...
    loadCourses() {
      axios({ method: "get", url: "student/application/loadstep1data" }).then(
        response => {
          ...
          if (this.count == 0) {
            ...
            this.step_one_form.first_name = this.application_old.first_name;
            this.step_one_form.middle_name =
