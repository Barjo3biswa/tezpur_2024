      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
                  ...
                  ">
                    ...
                    <div class="col-md-6">
                      <div class="row2">
                        ...
                        <div class="panel-body text-info text-bold" v-html="course.eligibility"></div>
                      </div>
                    </div>
                    <!-- Ends -->
            ...
            <div class="row" v-if="
              initial_step.selection_count == true && initial_step.preference_count == true && isAllowNext == true
            ">
              <!--<div
              class="row"
              v-if="
              ...
              <div class="col-md-12" style="padding-top:18px;">
                <div class="panel panel-info">
                  <h5 class="text-center" style="font-size:14px;font-weight:550;">
                    ...
                    <span v-else>Decleration</span>
                  </h5>
                  <div class="panel-body text-info text-bold"> I Herbly Declear Those info are True </div>
                  ...
                  <div class="row" v-if="is_60 == true">
                    <div class="col-md-12">
                      <div class="checkbox" style="padding-left:12px;">
                        <label>
                          <input type="checkbox" v-model="initial_step.is_qualify" />I qualify
                        </label>
                      </div>
            ...
            <fieldset id="personal_information">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <date-picker :label="'5. DOB'" :input_data="step_one_form.dob" :errors="step_one_form.errors"
                  ...
                  <form-input :label="'(b) Caste'" :input_data="step_one_form.sub_caste" :errors="step_one_form.errors"
                    :error_attr="'sub_caste'" :placeholder="'Caste'" :required="true" :label_style="'margin-left:12px;'"
        ...
        <div class="col-md-12">
          <form name="step-one-update" class="form-horizontal form-class application-form">
            ...
            <fieldset id="academic_details">
              ...
              <label>
                <span class="text-info">1. Qualifications (* Write <span class="text-primary">NA/Zero</span> if not
                  available)</span>
              </label>
...
"></form-select>
    ...
    step_three_form.other_qualifications.errors.remarks
                      ...
                      <td>
                        <button type="button" class="btn btn-xs btn-warning" @click="removeQualification(qual)">
                          Remove
                        </button>
                      </td>
                    </tr>
              ...
              <div class="row jee" v-if="initial_step.is_cuet_ug == true || initial_step.is_cuet_pg == true">
                <div class="col-md-12">
                  <label>
                    <span class="text-info">2. CUET Details</span>
                    ...
                    <div class="panel-body">
                      ...
                      <div class="row">
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <form-input :label="'CUET score'" :input_data="step_three_form.cuet.cuet_score"
                              :errors="step_three_form.errors" :error_attr="'cuet_score'"
                              :placeholder="'Enter CUET Score'" :required="false" :label_style="'margin-left:12px;'"
                              :show_text_limit="false" v-if="step_three_form.is_cuet_qualified == true"
                              @inputDataChanged="
                                step_three_form.cuet.cuet_score = $event
                              "></form-input>
                          </div>
                          <div class="col-md-4">
                            <form-input :label="'CUET Rank'" :input_data="step_three_form.cuet.cuet_rank"
                              :errors="step_three_form.errors" :error_attr="'cuet_rank'"
                              :placeholder="'Enter CUET Rank'" :required="false" :label_style="'margin-left:12px;'"
                              :show_text_limit="false" v-if="step_three_form.is_cuet_qualified == true"
                              @inputDataChanged="
                                step_three_form.cuet.cuet_rank = $event
                              "></form-input>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row mba" v-if="is_mba">
                <div class="col-md-12">
                  <label>
                    3. CAT/MAT/ATMA/XAT Details (only for MBA student) (if not enter <span class="text-info">NA,
                      Zero</span>)
                  </label>
                  <div class="panel panel-default">
                    <div class="panel-body">
                    ...
                    <div class="col-md-6">
                      <div class="form-group" v-if="is_foreign == false">
                        <label for="is_sport_represented" class="col-md-7">
                          ...
                          <span v-else>2</span>. Are you medalistin any
                      ...
                      <form-select :label="'Medel Type'" :options="medals" :errors="step_three_form.errors"
                      ...
                      <form-select :label="'Sporting event'" :options="sports" :errors="step_three_form.errors"
                        :error_attr="'sport_played'" :value_attr="'id'" :name_attr="'name'" :required="true"
                        :old_value="step_three_form.sport_played" :old_value_attr="'id'" @changedSelect="
    ...
    step_four_form.errors2.document_passport_photo
                  ...
                  <div class="row" v-if="step_four_form.undertaking_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <img :src="step_four_form.undertaking_url" alt="undertaking" width="200px" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row" v-if="step_four_form.prc_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.prc_url" alt="undertaking" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.gate_score_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.gate_score_card_url" alt="undertaking" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="this.step_one_form.caste != '1'">
                      <label for="document_caste" class="col-md-4 margin-label">Category Certificate:</label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_caste" class="form-control input-sm input-sm"
                            @change="casteCertificateChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('document_caste', 'caste_certificate')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                          </div>
                        </div>
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.document_caste">{{ step_four_form.errors2.document_caste
                          }}</strong>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row" v-if="step_four_form.caste_certificate_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.caste_certificate_url" alt="undertaking" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="is_mbbt">
                      <label for="document_caste" class="col-md-4 margin-label">GAT-B score card: <strong
                    ...
                    <div class="row" v-if="step_four_form.gate_b_score_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.gate_b_score_card_url" alt="undertaking" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.ceed_score_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.ceed_score_card_url" alt="undertaking" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.bpl_card_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.bpl_card_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="is_ncl == true">
                      <label for="document_obc_ncl" class="col-md-4 margin-label">OBC(NCL) Certificate:</label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_obc_ncl" class="form-control input-sm input-sm"
                            @change="obcFileChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('document_obc_ncl', 'obc_ncl')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                          </div>
                        </div>
                        ...
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.document_obc_ncl">{{ step_four_form.errors2.document_obc_ncl
                          }}</strong>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="row" v-if="step_four_form.document_obc_ncl_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_obc_ncl_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row" v-if="step_four_form.document_passport_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <img :src="step_four_form.document_passport_url" alt="bpl" width="200px" />
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group" v-if="step_three_form.is_sport_represented == true">
                    <label for="document_sport_representation" class="col-md-4 margin-label">Certificate representing
                      Country/State in sports :
                    </label>
                    <div class="col-md-7">
                      <div class="input-group">
                  ...
                  <div class="row" v-if="this.step_four_form.sport_certificate_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <img :src="step_four_form.sport_certificate_url" alt="Passport Photo" width="200px" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" v-if="step_four_form.document_pwd_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <img :src="step_four_form.document_pwd_url" alt="bpl" width="200px" />
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group" v-if="step_one_form.is_employed == true && is_mba == false">
                  ...
                  <div class="row" v-if="step_four_form.document_noc_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <img :src="step_four_form.document_noc_url" alt="bpl" width="200px" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" v-if="step_four_form.undertaking_pass_appear_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <img :src="step_four_form.undertaking_pass_appear_url" alt="bpl" width="200px" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row" v-if="step_four_form.document_admit_jee_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_admit_jee_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" v-if="initial_step.is_cuet_ug == true || initial_step.is_cuet_pg == true">
                      <label for="document_admit_cuet" class="col-md-4 margin-label">
                        Admit Card of CUET (for UG & PG Programme) :
                        <span class="text-danger">*</span>
                      </label>
                      <div class="col-md-7">
                        <div class="input-group">
                          <input type="file" ref="document_admit_cuet" class="form-control input-sm input-sm"
                            @change="cuetAdmitCardChanged" accept=".jpg,.jpeg,.png" />
                          <div class="input-group-btn">
                            <button type="button" class="btn btn-default btn-sm" :disabled="singleFileUploadingProgress"
                              @click="uploadSingleFile('document_admit_cuet', 'cuet_admit')">
                              <i class="fa fa-upload"></i> Upload
                            </button>
                          </div>
                        </div>
                        ...
                        <strong class="small text-warning">Please insert undertaking if admit card is not
                          available.</strong>
                        <strong class="text-danger" style="display:block" v-if="step_four_form.errors.document_admit_cuet">{{
                            step_four_form.errors.document_admit_cuet
                        }}</strong>
                        <strong class="text-danger" style="display:block"
                          v-if="step_four_form.errors2.document_admit_cuet">{{ step_four_form.errors2.document_admit_cuet
                          }}</strong>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="row" v-if="step_four_form.document_admit_cuet_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_admit_cuet_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.bank_passbook_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.bank_passbook_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.document_net_slet_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_net_slet_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.document_ex_servicement_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_ex_servicement_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.document_driving_license_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_driving_license_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.document_ssn_equivalent_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_ssn_equivalent_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.document_passing_certificate_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_passing_certificate_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.document_marksheet_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_marksheet_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row" v-if="step_four_form.document_english_proficiency_certificate_url">
                      <div class="panel panel-info">
                        <div class="panel-body">
                          <div class="col-md-12">
                            <div class="image">
                              <img :src="step_four_form.document_english_proficiency_certificate_url" alt="bpl" width="200px" />
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row" v-if="step_four_form.document_additional_url">
                    <div class="panel panel-info">
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div class="image">
                            <img :src="step_four_form.document_additional_url" alt="undertaking" width="200px" />
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row" v-if="is_mba">
                ...
                <hr />
                <div class="col-md-6" v-for="mba_exam in mba_exams" @key="mba_exam + '_document'">
                  <div class="form-group">
...
export default {
  ...
  computed: {
    ...
    // },
    is_mtech() {
      // alert(this.initial_step.course_type.code);
  ...
  methods: {
    ...
    loadOldApplication(id) {
      axios({
        ...
        this.initial_step.course_typeII = response.data.course_typeII;

        console.log("its"+ this.initial_step.course_typeII);
    ...
    casteCertificateChanged() {
      ...
      this.step_four_form.caste_certificate_url = URL.createObjectURL(
        this.step_four_form.document_caste
      );
    },
    bplFileChanged() {
    ...
    obcFileChanged() {
      ...
      this.step_four_form.document_obc_ncl_url = URL.createObjectURL(
        this.step_four_form.document_obc_ncl
      );
    ...
    cuetAdmitCardChanged(){
      this.step_four_form.document_admit_cuet = this.$refs.document_admit_cuet.files[0];
      this.step_four_form.document_admit_cuet_url = URL.createObjectURL(
        this.step_four_form.document_admit_cuet
      );
    },
    bankPassbookChanged(){
    ...
    checkCourseNew(course) {
      if (course.is_checked == false) {
        ...
        if (count < this.initial_step.pref_limit) {
          ...
          this.initial_step.preference_count = false;
    ...
    loadCourses() {
      axios({ method: "get", url: "student/application/loadstep1data" }).then(
        response => {
          ...
          // console.log(this.initial_step.course_types);
    ...
    openPreviewInNewWindow() {
      ...
      window.open(
        this.base_url + '/student/applicationii/' + id, "_blank");
    },
