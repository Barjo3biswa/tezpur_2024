...
class CreateRePaymentSuccessesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('re_payment_successes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('re_payment_successes');
    }
}
